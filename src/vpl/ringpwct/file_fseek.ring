...
class file_fseekComponentController from ComponentControllerParent 
	...
	func GenerateAction 
				...
				NewStep( StepData(:Value4) + " = "  +  T_CT_FILE_FSEEK_ST_VALUE  +
					 StepData(:Value ) +  T_CT_FILE_FSEEK_ST_VALUE2 + 
					StyleData(T_CT_FILE_FSEEK_IP_VALUE2LIST[Variable(:Value2)]) +
		T_CT_FILE_FSEEK_ST_VALUE3 + StepData(:Value3) )
...
class file_fseekComponentView from ComponentViewParent
		...
		ListBox( T_CT_FILE_FSEEK_IP_VALUE2 , :value2, 
				T_CT_FILE_FSEEK_IP_VALUE2LIST )
