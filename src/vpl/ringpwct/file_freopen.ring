...
class file_freopenComponentController from ComponentControllerParent 
	...
	func GenerateAction 
						...
						NewStep( T_CT_FILE_FREOPEN_ST_VALUE  + StepData(:Value ) +  T_CT_FILE_FREOPEN_ST_VALUE2 +
								StyleData(T_CT_FILE_FREOPEN_IP_VALUE2LIST[Variable(:value2)]) + T_CT_FILE_FREOPEN_ST_VALUE3 + StepData(:Value3) )
...
class file_freopenComponentView from ComponentViewParent
		...
		ListBox( T_CT_FILE_FREOPEN_IP_VALUE2 , :value2, 
				T_CT_FILE_FREOPEN_IP_VALUE2LIST )
