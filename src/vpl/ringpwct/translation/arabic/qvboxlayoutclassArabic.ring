...
T_CT_QVBOXLAYOUTCLASS_IP_VALUE2LIST = [
    "تنشيط(لاشىء) --> منطقية",
    "إضافة تخطيط(تخطيط *) --> لاشىء",
    "إضافة عنصر فراغ(عنصر فراغ *) --> لاشىء",
    "إضافة تباعد(عدد صحيح الحجم) --> لاشىء",
    "إضافة تمدد(عدد صحيح التمدد) --> لاشىء",
    "إضافة دعامة(عدد صحيح الحجم) --> لاشىء",
    "إضافة عنصر واجهة(عنصر واجهة *) --> لاشىء",
    "حجب الإشارات(منطقية حجب) --> منطقية",
    "أطفال(لاشىء) --> قائمة كائنات",
    "أقرب حجم مقبول(عنصر واجهة *عنصر، حجم) --> حجم",
    "هوامش المحتوى(لاشىء) --> هوامش",
    "مستطيل المحتوى(لاشىء) --> مستطيل",
    "حذف(لاشىء) --> لاشىء",
    "احذف لاحقاً(لاشىء) --> لاشىء",
    "اتجاه(لاشىء) --> اتجاه التخطيط",
    "تفريغ معلومات الكائن(لاشىء) --> لاشىء",
    "تفريغ شجرة الكائن(لاشىء) --> لاشىء",
    "الحصول على هوامش المحتوى(عدد صحيح *يسار، عدد صحيح *أعلى، عدد صحيح *يمين، عدد صحيح *أسفل) --> لاشىء",
    "يرث(حرف *اسم الفئة) --> منطقية",
    "تهيئة(الأصل) --> كائن",
    "إدراج تخطيط(عدد صحيح الفهرس، تخطيط *تخطيط، عدد صحيح التمدد) --> لاشىء",
    "إدراج عنصر فراغ(عدد صحيح الفهرس، عنصر فراغ *) --> لاشىء",
    "إدراج تباعد(عدد صحيح الفهرس، عدد صحيح الحجم) --> لاشىء",
    "إدراج تمدد(عدد صحيح الفهرس، عدد صحيح التمدد) --> لاشىء",
    "إدراج عنصر واجهة(عدد صحيح الفهرس، عنصر واجهة *عنصر، عدد صحيح التمدد، محاذاة) --> لاشىء",
    "تثبيت مرشح الحدث(كائن *مرشح) --> لاشىء",
    "مُمكّن(لاشىء) --> منطقية",
    "نوع الواجهة(لاشىء) --> منطقية",
    "إيقاف المؤقت(عدد صحيح المعرف) --> لاشىء",
    "شريط القائمة(لاشىء) --> عنصر واجهة",
    "نقل إلى الخيط(خيط *الخيط المستهدف) --> لاشىء",
    "اسم الكائن(لاشىء) --> نص",
    "مؤشر الكائن(لاشىء) --> مؤشر",
    "الأصل(لاشىء) --> كائن",
    "واجهة الأصل(لاشىء) --> عنصر واجهة",
    "خاصية(حرف *اسم) --> نوع متغير",
    "إزالة مرشح الحدث(كائن *كائن) --> لاشىء",
    "إزالة عنصر(عنصر تخطيط *) --> لاشىء",
    "إزالة عنصر واجهة(عنصر واجهة *) --> لاشىء",
    "تعيين المحاذاة(عنصر واجهة *عنصر، محاذاة) --> منطقية",
    "تعيين المحاذاة_2(محاذاة) --> لاشىء",
    "تعيين المحاذاة_3(تخطيط *تخطيط، محاذاة) --> منطقية",
    "تعيين هوامش المحتوى(عدد صحيح يسار، عدد صحيح أعلى، عدد صحيح يمين، عدد صحيح أسفل) --> لاشىء",
    "تعيين هوامش المحتوى_2(هوامش) --> لاشىء",
    "تعيين الاتجاه(اتجاه التخطيط) --> لاشىء",
    "تعيين التمكين(منطقية تمكين) --> لاشىء",
    "تعيين شريط القائمة(عنصر واجهة *عنصر) --> لاشىء",
    "تعيين اسم الكائن(نص) --> لاشىء",
    "تعيين الأصل(كائن *الأصل) --> لاشىء",
    "تعيين خاصية(حرف *اسم، نوع متغير) --> منطقية",
    "تعيين خاصية_2(حرف *اسم، عدد صحيح) --> منطقية",
    "تعيين خاصية_3(حرف *اسم، عائم) --> منطقية",
    "تعيين خاصية_4(حرف *اسم، مزدوج) --> منطقية",
    "تعيين خاصية_5(حرف *اسم، نص) --> منطقية",
    "تعيين خاصية_مزدوج(حرف *اسم، مزدوج) --> منطقية",
    "تعيين خاصية_عائم(حرف *اسم، عائم) --> منطقية",
    "تعيين خاصية_عدد صحيح(حرف *اسم، عدد صحيح) --> منطقية",
    "تعيين خاصية_نص(حرف *اسم، نص) --> منطقية",
    "تعيين قيد الحجم(قيد الحجم) --> لاشىء",
    "تعيين التباعد(عدد صحيح التباعد) --> لاشىء",
    "تعيين التمدد(عدد صحيح الفهرس، عدد صحيح التمدد) --> لاشىء",
    "تعيين عامل التمدد(عنصر واجهة *عنصر، عدد صحيح التمدد) --> منطقية",
    "تعيين عامل التمدد_2(تخطيط *تخطيط، عدد صحيح التمدد) --> منطقية",
    "حجب الإشارات(لاشىء) --> منطقية",
    "قيد الحجم(لاشىء) --> قيد الحجم",
    "التباعد(لاشىء) --> عدد صحيح",
    "تشغيل المؤقت(عدد صحيح الفاصل الزمني) --> عدد صحيح",
    "تمدد(عدد صحيح الفهرس) --> عدد صحيح",
    "الخيط(لاشىء) --> خيط",
    "تحديث(لاشىء) --> لاشىء"
]
