...
T_CT_QSQLQUERYCLASS_IP_VALUE2LIST = [
    "إضافة قيمة الربط(نوع متغير، نوع المعلمة) --> لاشىء",
    "في(لاشىء) --> عدد صحيح",
    "قيمة الربط(نص، نوع متغير، نوع المعلمة) --> لاشىء",
    "القيمة المرتبطة(نص) --> نوع متغير",
    "مسح(لاشىء) --> لاشىء",
    "حذف(لاشىء) --> لاشىء",
    "برنامج التشغيل(لاشىء) --> برنامج تشغيل قاعدة بيانات",
    "تنفيذ(نص) --> منطقية",
    "تنفيذ_2(لاشىء) --> منطقية",
    "تنفيذ الدفعة(وضع تنفيذ الدفعة) --> منطقية",
    "تنفيذ الاستعلام(لاشىء) --> نص",
    "إنهاء(لاشىء) --> لاشىء",
    "أول(لاشىء) --> منطقية",
    "تهيئة(الأصل) --> كائن",
    "نشط(لاشىء) --> منطقية",
    "للأمام فقط(لاشىء) --> منطقية",
    "قيمة عدمية(عدد صحيح الحقل) --> منطقية",
    "تحديد(لاشىء) --> منطقية",
    "صالح(لاشىء) --> منطقية",
    "آخر(لاشىء) --> منطقية",
    "آخر خطأ(لاشىء) --> خطأ قاعدة بيانات",
    "آخر معرف تم إدخاله(لاشىء) --> نوع متغير",
    "آخر استعلام(لاشىء) --> نص",
    "تحريك التالي(لاشىء) --> منطقية",
    "النتيجة التالية(لاشىء) --> منطقية",
    "سياسة الدقة التعددية(لاشىء) --> سياسة الدقة التعددية",
    "عدد الصفوف المتأثرة(لاشىء) --> عدد صحيح",
    "مؤشر الكائن(لاشىء) --> مؤشر",
    "تحضير(نص) --> منطقية",
    "سابق(لاشىء) --> منطقية",
    "سجل(لاشىء) --> سجل قاعدة بيانات",
    "نتيجة(لاشىء) --> نتيجة قاعدة بيانات",
    "بحث(عدد صحيح الفهرس، منطقية نسبي) --> منطقية",
    "تعيين للأمام فقط(منطقية للأمام) --> لاشىء",
    "تعيين سياسة الدقة التعددية(سياسة الدقة التعددية) --> لاشىء",
    "حجم(لاشىء) --> عدد صحيح",
    "قيمة(عدد صحيح الفهرس) --> نوع متغير"
]
