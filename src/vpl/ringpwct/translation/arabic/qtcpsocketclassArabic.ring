...
T_CT_QTCPSOCKETCLASS_IP_VALUE2LIST = [
    "إلغاء(لاشىء) --> لاشىء",
    "فيالنهاية(لاشىء) --> منطقية",
    "ربط(عنوان المضيف، عدد صحيح منفذ، علم الربط) --> منطقية",
    "حجبالإشارات(منطقية حجب) --> منطقية",
    "بايتاتمتاحة(لاشىء) --> عدد صحيح",
    "بايتاتللكتابة(لاشىء) --> عدد صحيح",
    "يمكنقراءةالسطر(لاشىء) --> منطقية",
    "أطفال(لاشىء) --> قائمةالكائنات",
    "إغلاق(لاشىء) --> لاشىء",
    "الاتصالبالمضيف(اسم المضيف، عدد صحيح منفذ، علم فتح الوضع، بروتوكول الطبقة الشبكية) --> لاشىء",
    "حذف(لاشىء) --> لاشىء",
    ...
    "نصالخطأ(لاشىء) --> نص",
    "تفريغ(لاشىء) --> منطقية",
    "الحصولعلىحدثالإغلاقالمتوقع(لاشىء) --> حرف",
    "الحصولعلىحدثالبايتاتالمكتوبة(لاشىء) --> حرف",
    "الحصولعلىمحرف(حرف *محرف) --> منطقية",
    "الحصولعلىحدثالاتصال(لاشىء) --> حرف",
    "الحصولعلىحدثالفصل(لاشىء) --> حرف",
    "الحصولعلىحدثالخطأ(لاشىء) --> حرف",
    "الحصولعلىحدثالعثورعلىالمضيف(لاشىء) --> حرف",
    "الحصولعلىحدثطلبمصادقةالوكيل(لاشىء) --> حرف",
    "الحصولعلىحدثانتهاءقناةالقراءة(لاشىء) --> حرف",
    "الحصولعلىحدثالقراءةجاهزة(لاشىء) --> حرف",
    "الحصولعلىحدثتغييرالحالة(لاشىء) --> حرف",
    "يرث(حرف *اسمالفئة) --> منطقية",
    "تهيئة(الأصل) --> كائن",
    "تثبيتالمرشحالحدث(كائن *مرشحالحدث) --> لاشىء",
    "مفتوح(لاشىء) --> منطقية",
    "قابلللقراءة(لاشىء) --> منطقية",
    "تتابعي(لاشىء) --> منطقية",
    "تمكينوضعالنص(لاشىء) --> منطقية",
    "صالح(لاشىء) --> منطقية",
    "نوعالأداة(لاشىء) --> منطقية",
    "قابلللكتابة(لاشىء) --> منطقية",
    "إيقافالعداد(عدد صحيح معرف) --> لاشىء",
    "العنوانالمحلي(لاشىء) --> عنوانالمضيف",
    "المنفذالمحلي(لاشىء) --> عدد صحيح",
    "نقلالىالخيط(خيط *خيطالمستهدف) --> لاشىء",
    "اسمالكائن(لاشىء) --> نص",
    "مؤشرالكائن(لاشىء) --> مؤشر",
    "فتح(وضعالفتح) --> منطقية",
    "وضعالفتح(لاشىء) --> عدد صحيح",
    "الأصل(لاشىء) --> كائن",
    "وضعالتوقف(لاشىء) --> عدد صحيح",
    "إطلالة(حرف *بيانات، عدد صحيح أقصىحجم) --> عدد صحيح",
    "عنوانالنظير(لاشىء) --> عنوانالمضيف",
    "اسمالنظير(لاشىء) --> نص",
    "منفذالنظير(لاشىء) --> عدد صحيح",
    "الموضع(لاشىء) --> عددمضاعف64",
    "خاصية(حرف *اسم) --> نوعمتغير",
    "الوكيل(لاشىء) --> وكيلشبكة",
    "إدخالمحرف(حرف محرف) --> منطقية",
    "قراءة(حرف *بيانات، عدد صحيح أقصىحجم) --> عدد صحيح",
    "قراءةالكل(لاشىء) --> مصفوفةبايتات",
    "حجمذاكرةالقراءة(لاشىء) --> عدد صحيح",
    "قراءةالسطر(حرف *بيانات، عدد صحيح أقصىحجم) --> عدد صحيح",
    "إزالةالمرشحالحدث(كائن *كائن) --> لاشىء",
    "استئناف(لاشىء) --> لاشىء",
    "بحث(عددمضاعف64 الموضع) --> منطقية",
    "تعيينحدثالإغلاقالمتوقع(حرف *) --> لاشىء",
    "تعيينحدثالبايتاتالمكتوبة(حرف *) --> لاشىء",
    "تعيينحدثالاتصال(حرف *) --> لاشىء",
    "تعيينحدثالفصل(حرف *) --> لاشىء",
    "تعيينحدثالخطأ(حرف *) --> لاشىء",
    "تعيينحدثالعثورعلىالمضيف(حرف *) --> لاشىء",
    "تعييناسمالكائن(نص) --> لاشىء",
    "تعيينالأصل(كائن *الأصل) --> لاشىء",
    "تعيينوضعتوقف(وضعالتوقف) --> لاشىء",
    "تعيينخاصية(حرف *اسم، نوعمتغير) --> منطقية",
    "تعيينخاصية_2(حرف *اسم، عدد صحيح) --> منطقية",
    "تعيينخاصية_3(حرف *اسم، عائم) --> منطقية",
    "تعيينخاصية_4(حرف *اسم، مزدوج) --> منطقية",
    "تعيينخاصية_5(حرف *اسم، نص) --> منطقية",
    "تعيينخاصية_مزدوج(حرف *اسم، مزدوج) --> منطقية",
    "تعيينخاصية_عائم(حرف *اسم، عائم) --> منطقية",
    "تعيينخاصية_عددصحيح(حرف *اسم، عدد صحيح) --> منطقية",
    "تعيينخاصية_نص(حرف *اسم، نص) --> منطقية",
    "تعيينوكيل(وكيلشبكة) --> لاشىء",
    "تعيينحدثطلبمصادقةالوكيل(حرف *) --> لاشىء",
    "تعيينحجمذاكرةالقراءة(عدد صحيح الحجم) --> لاشىء",
    "تعيينحدثانتهاءقناةالقراءة(حرف *) --> لاشىء",
    "تعيينحدثالقراءةجاهزة(حرف *) --> لاشىء",
    "تعيينمعرفالمقبس(عددمضاعفsocketDescriptor، حالةالمقبس، علمفتحالوضع) --> منطقية",
    "تعيينخيارالمقبس(خيارالمقبس، نوعمتغير القيمة) --> لاشىء",
    "تعيينحدثتغييرالحالة(حرف *) --> لاشىء",
    "تمكينوضعالنص(منطقية ممكن) --> لاشىء",
    "حجبالإشارات(لاشىء) --> منطقية",
    "الحجم(لاشىء) --> عددمضاعف64",
    "معرفالمقبس(لاشىء) --> عدد صحيح",
    "خيارالمقبس(خيارالمقبس) --> نوعمتغير",
    "نوعالمقبس(لاشىء) --> عدد صحيح",
    "تشغيلالمؤقت(عدد صحيح الفاصل) --> عدد صحيح",
    "الحالة(لاشىء) --> عدد صحيح",
    "خيط(لاشىء) --> خيط",
    "إعادةمحرف(حرف محرف) --> لاشىء",
    "انتظارالكتابة(عدد صحيح ميليثانية) --> منطقية",
    "انتظارالاتصال(عدد صحيح ميليثانية) --> منطقية",
    "انتظارالفصل(عدد صحيح ميليثانية) --> منطقية",
    "انتظارالقراءة(عدد صحيح ميليثانية) --> منطقية",
    "كتابة(حرف *بيانات، عدد صحيح أقصىحجم) --> عدد صحيح"
]
...
T_CT_QTCPSOCKETCLASS_IP_VALUE2STEPFUNC = [
    ...
    "نصالخطأ",
    "تفريغ",
    "الحصولعلىحدثالإغلاقالمتوقع",
    "الحصولعلىحدثالبايتاتالمكتوبة",
    "الحصولعلىمحرف",
    "الحصولعلىحدثالاتصال",
    "الحصولعلىحدثالفصل",
    "الحصولعلىحدثالخطأ",
    "الحصولعلىحدثالعثورعلىالمضيف",
    "الحصولعلىحدثطلبمصادقةالوكيل",
    "الحصولعلىحدثانتهاءقناةالقراءة",
    "الحصولعلىحدثالقراءةجاهزة",
    "الحصولعلىحدثتغييرالحالة",
    "يرث",
    "تهيئة",
    "تثبيتالمرشحالحدث",
    "مفتوح",
    ...
    "استئناف",
    "بحث",
    "تعيينحدثالإغلاقالمتوقع",
    "تعيينحدثالبايتاتالمكتوبة",
    "تعيينحدثالاتصال",
    "تعيينحدثالفصل",
    "تعيينحدثالخطأ",
    "تعيينحدثالعثورعلىالمضيف",
    "تعييناسمالكائن",
    "تعيينالأصل",
    "تعيينوضعتوقف",
    "تعيينخاصية",
    ...
    "تعيينخاصية_نص",
    "تعيينوكيل",
    "تعيينحدثطلبمصادقةالوكيل",
    "تعيينحجمذاكرةالقراءة",
    "تعيينحدثانتهاءقناةالقراءة",
    "تعيينحدثالقراءةجاهزة",
    "تعيينمعرفالمقبس",
    "تعيينخيارالمقبس",
    "تعيينحدثتغييرالحالة",
    "تمكينوضعلنص",
