...
T_CT_SECURITYCLASS_IP_VALUE2STEPFUNC = [
    "فك_التشفير",
    "تشفير",
    "معدل_تجزئة_MD5",
    "بايتات_عشوائية",
...
T_CT_SECURITYCLASS_IP_VALUE2LIST = [
    "فك_التشفير(سلسلة,مفتاح,متجه_التهيئة) --> سلسلة",
    "تشفير(سلسلة,مفتاح,متجه_التهيئة) --> سلسلة",
    "معدل_تجزئة_MD5(سلسلة) --> سلسلة",
    "بايتات_عشوائية(حجم) --> سلسلة",
    "معدل_تجزئة_SHA1(سلسلة) --> سلسلة",
    "معدل_تجزئة_SHA224(سلسلة) --> سلسلة",
    "معدل_تجزئة_SHA256(سلسلة) --> سلسلة",
    "معدل_تجزئة_SHA384(سلسلة) --> سلسلة",
    "معدل_تجزئة_SHA512(سلسلة) --> سلسلة"
]
