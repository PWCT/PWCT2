...
T_CT_QPIXMAPCLASS_IP_VALUE2LIST = [
"مفتاح المخبأ( لا شيء ) --> عدد صحيح طويل بنوع التحديد",
"تحويل من صورة( صورة عابرة, أعلام تحويل الصورة ) --> منطقي",
"نسخ( عدد صحيح س , عدد صحيح ص , عدد صحيح عرض , عدد صحيح ارتفاع ) --> بكسل تكوين",
"نسخ ٢( مستطيل ) --> بكسل تكوين",
"إنشاء قناع تقديري( قص مشدود ) --> قناع بكسل",
"إنشاء قناع من اللون( لون , طريقة القناع ) --> قناع بكسل",
"العمق الافتراضي( لا شيء ) --> عدد صحيح",
"حذف( لا شيء ) --> لا شيء",
"العمق( لا شيء ) --> عدد صحيح",
"فصل( لا شيء ) --> لا شيء",
"نسبة بكسل الجهاز( لا شيء ) --> كسر عشري حقيقي",
"ملء( لون ) --> لا شيء",
"من الصورة( صورة عابرة, أعلام تحويل الصورة ) --> بكسل تكوين",
"من الصورة ٢( صورة عابرة , أعلام تحويل الصورة ) --> بكسل تكوين",
"من قارئ الصورة( قارئ صورة *قارئ الصورة , أعلام تحويل الصورة ) --> بكسل تكوين",
"هل لديه شفافية( لا شيء ) --> منطقي",
"هل لديه قناة شفافية( لا شيء ) --> منطقي",
"ارتفاع( لا شيء ) --> عدد صحيح",
"تهيئة( الأب ) --> كائن",
"هل فارغ( لا شيء ) --> منطقي",
"هل هو قناع بكسل( لا شيء ) --> منطقي",
"تحميل من البيانات( بيانات ثابتة, طول, تنسيق, أعلام تحويل الصورة ) --> منطقي",
"تحميل من البيانات ٢( مصفوفة بايت عشوائية, تنسيق, أعلام تحويل الصورة ) --> منطقي",
"تحميل بكسل من ملف عبارة( اسم الملف, تنسيق, أعلام تحويل الصورة ) --> منطقي",
"قناع( لا شيء ) --> قناع بكسل",
"مؤشر كائن( لا شيء ) --> مؤشر",
"مستطيل( لا شيء ) --> مستطيل",
"حفظ( اسم الملف, تنسيق, جودة ) --> منطقي",
"حفظ ٢( جهاز إدخال إخراج, تنسيق, جودة ) --> منطقي",
"تحجيم( عرض, ارتفاع, وضعية نسبة الأبعاد, وضعية التحويل ) --> بكسل تكوين",
"تحجيم ٢( حجم, وضعية نسبة الأبعاد, وضعية التحويل ) --> بكسل تكوين",
"تحجيم لارتفاع( ارتفاع, وضعية التحويل ) --> بكسل تكوين",
"تحجيم لعرض( عرض, وضعية التحويل ) --> بكسل تكوين",
"تمرير( تحول س, تحول ص, عدد صحيح س , عدد صحيح ص , عدد صحيح عرض , عدد صحيح ارتفاع, منطقة مرئية ) --> لا شيء",
"تمرير ٢( تحول س, تحول ص, مستطيل, منطقة مرئية ) --> لا شيء",
"تعيين نسبة بكسل الجهاز( مقياس العامل ) --> لا شيء",
"تعيين قناع( قناع بكسل ) --> لا شيء",
"حجم( لا شيء ) --> حجم",
"تبديل( بكسل تكوين آخر ) --> لا شيء",
"إلى صورة( لا شيء ) --> صورة عابرة",
"تحول( تحويل, وضعية التحويل ) --> بكسل تكوين",
"تحول ٢( مصفوفة, وضعية التحويل ) --> بكسل تكوين",
"مصفوفة صحيحة( تحويل, عرض, ارتفاع ) --> تحويل",
"مصفوفة صحيحة ٢( مصفوفة, عرض, ارتفاع ) --> مصفوفة",
"عرض( لا شيء ) --> عدد صحيح"
]
