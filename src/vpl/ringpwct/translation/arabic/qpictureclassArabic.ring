...
T_CT_QPICTURECLASS_IP_VALUE2LIST = [
"مستطيل الإحاطة( لا شيء ) --> مستطيل",
"بيانات( لا شيء ) --> حرف",
"حذف( لا شيء ) --> لا شيء",
"تهيئة( الأب ) --> كائن",
"هل فارغ( لا شيء ) --> منطقي",
"تحميل ملف( سلسلة نصية, تنسيق ) --> منطقي",
"مؤشر كائن( لا شيء ) --> مؤشر",
"تشغيل( رسام* ) --> منطقي",
"حفظ( سلسلة نصية, تنسيق ) --> منطقي",
"تعيين مستطيل الإحاطة( مستطيل ) --> لا شيء",
"حجم( لا شيء ) --> عدد صحيح",
"تبديل( صورة رسم ) --> لا شيء"
]
