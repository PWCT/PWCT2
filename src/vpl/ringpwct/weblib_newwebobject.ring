...
class weblib_newwebobjectComponentController from ComponentControllerParent 
	...
	func GenerateAction 
				...
				switch Variable(:Value) {
					...
					case 1 cObjName = "Page" 
					case 2 cObjName = "Pagebuffer" 
					case 3 cObjName = "HTML2PDF" 
					case 4 cObjName = "BootStrapPage" 
					case 5 cObjName = "WebPage" 
...
class weblib_newwebobjectComponentView from ComponentViewParent
		...
		ListBox( T_CT_WEBLIB_NEWWEBOBJECT_IP_VALUE , :value, 
				T_CT_WEBLIB_NEWWEBOBJECT_IP_VALUE2LIST )
		PageButtons()
