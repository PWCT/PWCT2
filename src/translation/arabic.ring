...
# Output Window - Error Messages Translation 
	...
	T_OUTPUT_ERRORMSG = [
	    ["Error (R1) : Can't divide by zero", "خطأ (R1) : لا يمكن القسمة على صفر"],
	    ["Error (R2) : Array Access (Index out of range)", "خطأ (R2) : الوصول إلى المصفوفة (المؤشر خارج النطاق)"],
	    ["Error (R3) : Calling Function without definition", "خطأ (R3) : استدعاء دالة بدون تعريف"],
	    ["Error (R4) : Stack Overflow", "خطأ (R4) : تجاوز الحد الأقصى للمكدس"],
	    ["Error (R5) : Can't access the list item, Object is not list", "خطأ (R5) : لا يمكن الوصول إلى عنصر القائمة، الكائن ليس قائمة"],
	    ["Error (R6) : Variable is required", "خطأ (R6) : المتغير مطلوب"],
	    ["Error (R7) : Can't assign to a string letter more than one character", "خطأ (R7) : لا يمكن إسناد أكثر من حرف واحد إلى حرف في النص"],
	    ["Error (R8) : Variable is not a string", "خطأ (R8) : المتغير ليس نصًا"],
	    ["Error (R9) : Using exit command outside loops", "خطأ (R9) : استخدام أمر الخروج خارج الحلقات"],
	    ["Error (R10) : Using exit command with number outside the range", "خطأ (R10) : استخدام أمر الخروج برقم خارج النطاق"],
	    ["Error (R11) : Error in class name, class not found", "خطأ (R11) : خطأ في اسم الفئة، الفئة غير موجودة"],
	    ["Error (R12) : Error in property name, property not found", "خطأ (R12) : خطأ في اسم الخاصية، الخاصية غير موجودة"],
	    ["Error (R13) : Object is required", "خطأ (R13) : الكائن مطلوب"],
	    ["Error (R14) : Calling Method without definition", "خطأ (R14) : استدعاء طريقة بدون تعريف"],
	    ["Error (R15) : Error in parent class name, class not found", "خطأ (R15) : خطأ في اسم الفئة الأصلية، الفئة غير موجودة"],
	    ["Error (R16) : Using braces to access unknown object", "خطأ (R16) : استخدام الأقواس للوصول إلى كائن غير معروف"],
	    ["Error (R17) : Error, using 'Super' without parent class", "خطأ (R17) : خطأ، استخدام 'Super' بدون فئة أصلية"],
	    ["Error (R18) : Numeric Overflow", "خطأ (R18) : تجاوز رقمي"],
	    ["Error (R19) : Calling function with less number of parameters", "خطأ (R19) : استدعاء دالة بعدد أقل من المعلمات"],
	    ["Error (R20) : Calling function with extra number of parameters", "خطأ (R20) : استدعاء دالة بعدد زائد من المعلمات"],
	    ["Error (R21) : Using operator with values of incorrect type", "خطأ (R21) : استخدام عامل مع قيم من نوع غير صحيح"],
	    ["Error (R22) : Using loop command outside loops", "خطأ (R22) : استخدام أمر الحلقة خارج الحلقات"],
	    ["Error (R23) : Using loop command with number outside the range", "خطأ (R23) : استخدام أمر الحلقة برقم خارج النطاق"],
	    ["Error (R24) : Using uninitialized variable", "خطأ (R24) : استخدام متغير غير مهيأ"],
	    ["Error (R25) : Error in package name, Package not found", "خطأ (R25) : خطأ في اسم الحزمة، الحزمة غير موجودة"],
	    ["Error (R26) : Calling private method from outside the class", "خطأ (R26) : استدعاء طريقة خاصة من خارج الفئة"],
	    ["Error (R27) : Using private attribute from outside the class", "خطأ (R27) : استخدام خاصية خاصة من خارج الفئة"],
	    ["Error (R28) : Using bad data type as step value", "خطأ (R28) : استخدام نوع بيانات غير صالح كقيمة خطوة"],
	    ["Error (R29) : Using bad data type in for loop", "خطأ (R29) : استخدام نوع بيانات غير صالح في حلقة for"],
	    ["Error (R30) : Parent class name is identical to child class name", "خطأ (R30) : اسم الفئة الأصلية مطابق لاسم الفئة الفرعية"],
	    ["Error (R31) : Trying to destroy the object using the self reference", "خطأ (R31) : محاولة تدمير الكائن باستخدام مرجع الذات"],
	    ["Error (R32) : The CALL command expects a variable containing a string", "خطأ (R32) : أمر CALL يتطلب متغير يحتوي على نص"],
	    ["Error (R33) : Bad decimals number (correct range >= 0 and <= 90)", "خطأ (R33) : رقم عشري غير صحيح (النطاق الصحيح >= 0 و <= 90)"],
	    ["Error (R34) : Variable is required for the assignment operation", "خطأ (R34) : المتغير مطلوب لعملية الإسناد"],
	    ["Error (R35) : Can't create/open the file", "خطأ (R35) : لا يمكن إنشاء/فتح الملف"],
	    ["Error (R36) : The column number is not correct!", "خطأ (R36) : رقم العمود غير صحيح!"],
	    ["Error (R37) : Sorry, The command is not supported in this context", "خطأ (R37) : عذرًا، الأمر غير مدعوم في هذا السياق"],
	    ["Error (R38) : Runtime Error in loading the dynamic library", "خطأ (R38) : خطأ وقت التشغيل في تحميل المكتبة الديناميكية"],
	    ["Error (R39) : Error occurred creating unique filename", "خطأ (R39) : خطأ حدث أثناء إنشاء اسم ملف فريد"],
	    ["Error (R40) : Numeric underflow", "خطأ (R40) : نقص رقمي"],
	    ["Error (R41) : Invalid numeric string", "خطأ (R41) : سلسلة رقمية غير صالحة"],
	    ["Error (R42) : Error in eval() function", "خطأ (R42) : خطأ في وظيفة eval()"],
	    ["Error (R43) : The variable contains a protected value", "خطأ (R43) : المتغير يحتوي على قيمة محمية"],
	    ["Error (R44) : Maximum nested Eval()", "خطأ (R44) : أقصى عدد متداخل من Eval()"],
	    ["Error (R45) : Variable is not a list", "خطأ (R45) : المتغير ليس قائمة"],
	    ["Error (R46) : The dynamic library doesn't contain the ringlib_init() function!", "خطأ (R46) : المكتبة الديناميكية لا تحتوي على وظيفة ringlib_init()!"],
	    ["Error (R47) : The function is not supported in this platform", "خطأ (R47) : الوظيفة غير مدعومة في هذه المنصة"],
	    ["Error (R48) : Assertion Failed!", "خطأ (R48) : فشل في التأكيد!"],
	    ["Error (R49) : The Ring VM is not created/ready", "خطأ (R49) : آلة Ring الافتراضية لم يتم إنشاؤها/جاهزة"],
	    ["Error (R50) : Object does not support operator overloading", "خطأ (R50) : الكائن لا يدعم زيادة تحميل المعاملات"],
	    ["Error (R51) : Value Error", "خطأ (R51) : خطأ في القيمة"],
	    ["Error (R52) : Using Return inside function parameters is not allowed", "خطأ (R52) : استخدام Return داخل معلمات الوظيفة غير مسموح"],
	    ["Error (R53) : Function redefinition, function is already defined!", "خطأ (R53) : إعادة تعريف الوظيفة، الوظيفة معرفة بالفعل!"],
	    ["Error (R54) : Object attribute redefinition, attribute is already defined!", "خطأ (R54) : إعادة تعريف خاصية الكائن، الخاصية معرفة بالفعل!"]
	]
