...
# PWCT Environment
	...
	T_EVN_MENU_SETMAINFILE = "تحديد الملف الاساسي ليكون الملف الحالى"
	T_EVN_MENU_MAINFILEDEBUG = "الملف الأساسي - تنقيح - تشغيل ثم إنتظار"
	T_EVN_MENU_MAINFILERUN = "الملف الأساسي - تشغيل"
	T_EVN_MENU_MAINFILERUNGUI = "الملف الأساسي - تشغيل تطبيق رسومي"
	T_EVN_MENU_MAINFILERUNWEB = "الملف الأساسي - تشغيل تطبيق ويب - افتح فى المتصفح"
