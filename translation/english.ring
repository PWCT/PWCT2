...
# PWCT Environment
	...
	T_EVN_MENU_SETMAINFILE = "Set the Main File to be the current source file"
	T_EVN_MENU_MAINFILEDEBUG = "Main File : Debug (Run then wait!)"
	T_EVN_MENU_MAINFILERUN = "Main File : Run"
	T_EVN_MENU_MAINFILERUNGUI = "Main File : Run GUI Application (No Console)"
	T_EVN_MENU_MAINFILERUNWEB = "Main File : Run Web Application (Open In Browser)"
