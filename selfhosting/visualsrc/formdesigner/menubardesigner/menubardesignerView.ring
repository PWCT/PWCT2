...
class menubardesignerView from WindowsViewParent
	win = new MainWindow()
	{
		move(0,0)
		resize(872,722)
		setWindowTitle(T_FROMDESIGNER_MB_MENUBARDESIGNER)
		#"Menubar Designer"
		...
		Label1 = new label(win)
		{
			move(8,24)
			resize(164,44)
			setText(T_FROMDESIGNER_MB_MENUITEMS)
			#"Menu Items"
		...
		Button2 = new pushbutton(win)
		{
			move(715,73)
			resize(129,34)
			setText(T_FROMDESIGNER_MB_DELETE)
			#"Delete"
		...
		Label2 = new label(win)
		{
			move(9,362)
			resize(163,31)
			setText(T_FROMDESIGNER_MB_TEXT)
			#"Text"
			setAlignment(Qt_AlignRight|Qt_AlignVCenter)
		}
		Label3 = new label(win)
		{
			move(9,403)
			resize(163,33)
			setText(T_FROMDESIGNER_MB_IMAGE)
			#"Image"
			setAlignment(Qt_AlignRight|Qt_AlignVCenter)
		}
		Label4 = new label(win)
		{
			move(9,446)
			resize(163,28)
			setText(T_FROMDESIGNER_MB_SHORTCUT)
			#"Shortcut"
			setAlignment(Qt_AlignRight|Qt_AlignVCenter)
		}
		Label5 = new label(win)
		{
			move(9,484)
			resize(160,34)
			setText(T_FROMDESIGNER_MB_ACTION)
			#"Action"
			setAlignment(Qt_AlignRight|Qt_AlignVCenter)
		}
		...
		Button3 = new pushbutton(win)
		{
			move(715,117)
			resize(129,34)
			setText(T_FROMDESIGNER_MB_CLOSE)
			#"Close"
