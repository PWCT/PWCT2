...
class FormDesigner_QLabel from QLabel
	...
	func AddObjectProperties oDesigner { 
		...
		#"Center"
		#"Right"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_TEXTALIGN,[T_FORMDESIGNER_ATTRIBUTE_TEXTALIGNLEFT,T_FORMDESIGNER_ATTRIBUTE_TEXTALIGNCENTER,T_FORMDESIGNER_ATTRIBUTE_TEXTALIGNRIGHT])
	} 
