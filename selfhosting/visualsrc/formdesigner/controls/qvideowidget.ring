...
class FormDesigner_QVideoWidget from QLineEdit
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_VIDEOFILE,True)
		#"Video File"
	} 
	...
	func GenerateCustomCode oDesigner { 
		cOutput = ""
		cOutput += "player#{f2} = new qmediaplayer() { "+nl+'setmedia(new qurl("#{f1}"))'+nl+" setvideooutput(#{f2})"+nl+"}"+nl
