...
class FormDesigner_QTreeWidget from QLineEdit
	...
	func AddObjectProperties oDesigner { 
		...
		#"Column Count"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_HEADERLABELSSCOMMA,False)
		#"Header Labels (S: Comma)"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_HEADERHIDDEN,[T_FORMDESIGNER_ATTRIBUTE_TRUE,T_FORMDESIGNER_ATTRIBUTE_FALSE])
		#"Header Hidden" "True" "False"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_COLLAPSEDEVENT,False)
		#"collapsedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_EXPANDEDEVENT,False)
		#"expandedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ACTIVATEDEVENT,False)
		#"activatedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CLICKEDEVENT,False)
		#"clickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_DOUBLECLICKEDEVENT,False)
		#"doubleClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ENTEREDEVENT,False)
		#"enteredEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_PRESSEDEVENT,False)
		#"pressedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_VIEWPORTENTEREDEVENT,False)
		#"viewportEnteredEvent"
		...
		#"itemClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMCOLLAPSEDEVENT,False)
		#"itemCollapsedEvent"
		...
		#"itemEnteredEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMEXPANDEDEVENT,False)
		#"itemExpandedEvent"
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+3) AND (nRow <= C_AFTERCOMMON+20) { 
