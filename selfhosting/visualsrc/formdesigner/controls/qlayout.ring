...
class FormDesigner_QLayout from QLabel
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_TYPE,[T_FORMDESIGNER_ATTRIBUTE_VERTICAL,T_FORMDESIGNER_ATTRIBUTE_HORIZONTAL])
		#"Type" "Vertical" "Horizontal"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_OBJECTSSCOMMA,True)
		#"Objects (S: Comma)"
	} 
	...
	func GenerateCode oDesigner { 
		cOutput = char(9)+char(9)+oDesigner.oModel.GetObjectName(self)+" = "+"new #{f1}() {
		#{f2}
				}"+nl
