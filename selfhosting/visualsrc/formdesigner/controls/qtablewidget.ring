...
class FormDesigner_QTableWidget from QLineEdit
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ROWCOUNT,False)
		#"Row Count"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_COLUMNCOUNT,False)
		#"Column Count"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_HORIZONTALHEADERSSCOMMA,False)
		#"Horizontal Headers (S: Comma)"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_COLUMNSWIDTHSCOMMA,False)
		#"Columns Width (S: Comma)"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_HORIZONTALHEADERSTYLE,False)
		#"Horizontal Header Style"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_VERTICALHEADERSTYLE,False)
		#"Vertical Header Style"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_SELECTIONBEHAVIOR,[T_FORMDESIGNER_ATTRIBUTE_ITEMS,T_FORMDESIGNER_ATTRIBUTE_ROWS,T_FORMDESIGNER_ATTRIBUTE_COLUMNS])
		#"Selection Behavior" "Items" "Rows" "Columns"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_ALTERNATINGROWCOLORS,[T_FORMDESIGNER_ATTRIBUTE_TRUE,T_FORMDESIGNER_ATTRIBUTE_FALSE])
		#"Alternating Row Colors" "True" "False"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLACTIVATEDEVENT,False)
		#"cellActivatedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLCHANGEDEVENT,False)
		#"cellChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLCLICKEDEVENT,False)
		#"cellClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLDOUBLECLICKEDEVENT,False)
		#"cellDoubleClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLENTEREDEVENT,False)
		#"cellEnteredEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CELLPRESSEDEVENT,False)
		#"cellPressedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURRENTCELLCHANGEDEVENT,False)
		#"currentCellChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURRENTITEMCHANGEDEVENT,False)
		#"currentItemChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMACTIVATEDEVENT,False)
		#"itemActivatedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMCHANGEDEVENT,False)
		#"itemChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMCLICKEDEVENT,False)
		#"itemClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMDOUBLECLICKEDEVENT,False)
		#"itemDoubleClickedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMENTEREDEVENT,False)
		#"itemEnteredEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMPRESSEDEVENT,False)
		#"itemPressedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ITEMSELECTIONCHANGEDEVENT,False)
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+8) AND (nRow <= C_AFTERCOMMON+22) { 
