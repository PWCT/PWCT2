...
class FormDesigner_QCheckBox from QCheckBox
	...
	func AddObjectProperties oDesigner { 
		...
		#"Text"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_STATECHANGEDEVENT,False)
		#"stateChangedEvent"
		...
		#"pressedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_RELEASEDEVENT,False)
		#"releasedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_TOGGLEDEVENT,False)
		#"toggledEvent"
	} 
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+1) AND (nRow <= C_AFTERCOMMON+5) { 
