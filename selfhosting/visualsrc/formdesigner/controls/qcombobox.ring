...
class FormDesigner_QComboBox from QComboBox
	...
	func AddObjectProperties oDesigner { 
		...
		#"Items (S: Comma)"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURRENTINDEX,False)
		#"Current Index"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ACTIVATEDEVENT,False)
		#"activatedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURRENTINDEXCHANGEDEVENT,False)
		#"currentIndexChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_EDITTEXTCHANGEDEVENT,False)
		#"editTextChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_HIGHLIGHTEDEVENT,False)
		#"highlightedEvent"
	} 
	func DisplayProperties oDesigner { 
		...
		#Set the object name
		clear()
		AddItem(oDesigner.oModel.GetObjectName(self),0)
	} 
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+2) AND (nRow <= C_AFTERCOMMON+5) { 
