...
class FormDesigner_QWebView from QLineEdit
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_URL,False)
		#"URL"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_LOADPROGRESSEVENT,False)
		#"loadProgressEvent "
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_LOADSTARTEDEVENT,False)
		#"loadStartedEvent "
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_SELECTIONCHANGEDEVENT,False)
		#"selectionChangedEvent "
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_URLCHANGEDEVENT,False)
		#"urlChangedEvent "
	} 
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+1) AND (nRow <= C_AFTERCOMMON+4) { 
