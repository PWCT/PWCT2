...
class FormDesigner_QAllEvents from QLabel
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CONTROLNAME,False)
		#"Control Name"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_KEYPRESSEVENT,False)
		#"KeyPressEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MOUSEBUTTONPRESSEVENT,False)
		#"MouseButtonPressEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MOUSEBUTTONRELEASEEVENT,False)
		#"MouseButtonReleaseEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MOUSEBUTTONDBLCLICKEVENT,False)
		#"MouseButtonDblClickEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MOUSEMOVEEVENT,False)
		#"MouseMoveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CLOSEEVENT,False)
		#"CloseEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CONTEXTMENUEVENT,False)
		#"ContextMenuEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_DRAGENTEREVENT,False)
		#"DragEnterEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_DRAGLEAVEEVENT,False)
		#"DragLeaveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_DRAGMOVEEVENT,False)
		#"DragMoveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_DROPEVENT,False)
		#"DropEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_ENTEREVENT,False)
		#"EnterEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_FOCUSINEVENT,False)
		#"FocusInEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_FOCUSOUTEVENT,False)
		#"FocusOutEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_KEYRELEASEEVENT,False)
		#"KeyReleaseEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_LEAVEEVENT,False)
		#"LeaveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_NONCLIENTAREAMOUSEBUTTONDBLCLICKEVENT,False)
		#"NonClientAreaMouseButtonDblClickEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_NONCLIENTAREAMOUSEBUTTONPRESSEVENT,False)
		#"NonClientAreaMouseButtonPressEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_NONCLIENTAREAMOUSEBUTTONRELEASEEVENT,False)
		#"NonClientAreaMouseButtonReleaseEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_NONCLIENTAREAMOUSEMOVEEVENT,False)
		#"NonClientAreaMouseMoveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MOVEEVENT,False)
		#"MoveEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_RESIZEEVENT,False)
		#"ResizeEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWACTIVATEEVENT,False)
		#"WindowActivateEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWBLOCKEDEVENT,False)
		#"WindowBlockedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWDEACTIVATEEVENT,False)
		#"WindowDeactivateEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWSTATECHANGEEVENT,False)
		#"WindowStateChangeEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWUNBLOCKEDEVENT,False)
		#"WindowUnblockedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_PAINTEVENT,False)
		#"PaintEvent"
	} 
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+1) AND (nRow <= C_AFTERCOMMON+28) { 
	...
	func GenerateCode oDesigner { 
		cOutput = char(9)+char(9)+"#{f4} = "+"new #{f1}(win) {
		#{f2}
				}
