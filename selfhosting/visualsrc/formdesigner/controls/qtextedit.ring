...
class FormDesigner_QTextEdit from QLineEdit
	...
	func AddObjectProperties oDesigner { 
		...
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_TEXT,False)
		#"Text"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_COPYAVAILABLEEVENT,False)
		#"copyAvailableEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURRENTCHARFORMATCHANGEDEVENT,False)
		#"currentCharFormatChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_CURSORPOSITIONCHANGEDEVENT,False)
		#"cursorPositionChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_REDOAVAIABLEEVENT,False)
		#"redoAvailableEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_SELECTIONCHANGEDEVENT,False)
		#"selectionChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_TEXTCHANGEDEVENT,False)
		#"textChangedEvent"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_UNDOAVAILABLEEVENT,False)
		#"undoAvailableEvent"
	} 
	...
	func UpdateProperties oDesigner,nRow,nCol,cValue { 
		...
		if nCol = 1 { 
			...
			if (nRow >= C_AFTERCOMMON+1) AND (nRow <= C_AFTERCOMMON+7) { 
