...
class FormDesigner_QWidget from QWidget
	...
	func AddObjectProperties oDesigner { 
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_X,False)
		#"X"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_Y,False)
		#"Y"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WIDTH,False)
		#"Width"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_HEIGHT,False)
		#"Height"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_TITLE,False)
		#"Title"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_BACKCOLOR,True)
		#"Back Color"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWFLAGS,True)
		#"Window Flags"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_SETLAYOUT,True)
		#"Set Layout"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_WINDOWICON,True)
		#"Window Icon"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_MENUBAR,True)
		#"Menubar"
		#"Index Type"
		#"Start from 1"
		#"Start from 0"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_INDEXTYPE,[T_FORMDESIGNER_ATTRIBUTE_STARTFROM1,T_FORMDESIGNER_ATTRIBUTE_STARTFROM0])
		#"GUI Library"
		#"GUILib"
		#"Light GUILib"
		oDesigner.oView.AddPropertyCombobox(T_FORMDESIGNER_ATTRIBUTE_GUILIBRARY,[T_FORMDESIGNER_ATTRIBUTE_GUILIB,T_FORMDESIGNER_ATTRIBUTE_LIGHTGUILIB])
	} 
	...
	func DialogButtonAction oDesigner,nRow { 
		switch nRow { 
			...
			case 6
				#Window Flags
				openWindowInPackages(:WindowFlagsController,["System.GUI"])
			...
			case 9
				#Menubar
				openWindowInPackages(:MenubarDesignerController,["System.GUI"])
				lastWindow().setParentObject(oDesigner)
	...
	func GenerateCode oDesigner { 
		cOutput = char(9)+char(9)+'move(#{f1},#{f2})
				resize(#{f3},#{f4})
				setWindowTitle("#{f5}")
