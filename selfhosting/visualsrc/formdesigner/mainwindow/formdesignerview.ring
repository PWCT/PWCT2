...
class FormDesignerView from WindowsViewParent
	...
	func CreateMainWindow oModel { 
		...
		win = new qMainwindow()
		{
			setWindowTitle(T_FORMDESIGNER_FORMDESIGNER)
			#"Form Designer"
		...
		if isMobile() { 
			...
			oDesignDock = new qDockWidget(NULL,0)
			{
				...
				setWindowTitle(T_FROMDESIGNER_DESIGN_WINDOWTITLE)
				#"Design Region"
	...
	func CreateMenuBar  { 
		...
		{
			subFile = addmenu(T_FORMDESIGNER_FILE)
			#"File"
			subFile {
				...
				oAction = new qaction(this.win)
				{
					settext(T_FORMDESIGNER_Download)
					#"Download"
			...
			subEdit = addmenu(T_FORMDESIGNER_EDIT)
			#"Edit"
			subEdit {
				oAction = new qAction(this.win)
				{
					setShortcut( new QKeySequence("Ctrl+shift+v"))
					settext(T_FORMDESIGNER_DUPLICATE)
					#"Duplicate"
				...
				oAction = new qAction(this.win)
				{
					...
					settext(T_FORMDESIGNER_BRINGTOFRONT)
					#"Bring to front"
				...
				oAction = new qAction(this.win)
				{
					...
					settext(T_FORMDESIGNER_SENDTOBACK)
					#"Send to back"
				...
				oAction = new qAction(this.win)
				{
					...
					settext(T_FORMDESIGNER_TOOLBAR_DELETE)
					#"Delete"
				...
				oAction = new qAction(this.win)
				{
					settext(T_FORMDESIGNER_TOOLBAR_SELECTOBJECTS)
					#"Select objects"
					setclickevent(Method(:SelectObjectsWindow))
				}
				addaction(oAction)
			}
			subView = addmenu(T_FORMDESIGNER_VIEW)
			#"View"
			subView {
				oAction = new qAction(this.win)
				{
					setShortcut( new QKeySequence("Ctrl+shift+t"))
					settext(T_FORMDESIGNER_TOOLBOX)
					#"ToolBox"
				...
				oAction = new qAction(this.win)
				{
					...
					settext(T_FORMDESIGNER_PROPERTIES)
					#"Properties"
				}
				addaction(oAction)
				addseparator()
			}
			subHelp = addmenu(T_FORMDESIGNER_HELP)
			#"Help"
			subHelp {
				if !isWebAssembly() { 
					subHelpLF = addmenu(T_FORMDESIGNER_LANGUAGEREFERENCE)
					#"Language Reference"
					subHelpLF {
						oAction = new qAction(this.win)
						{
							settext(T_FORMDESIGNER_CHMFILE)
							#"CHM File"
						...
						oAction = new qAction(this.win)
						{
							settext(T_FORMDESIGNER_PDFFILE)
							#"PDF File"
				...
				subHelpTools = addmenu(T_FORMDESIGNER_DEVELOPMENTTOOLS)
				#"Development Tools"
				subHelpTools {
					oAction = new qAction(this.win)
					{
						settext(T_FORMDESIGNER_PROGRAMMINGLANGUAGE)
					...
					oAction = new qAction(this.win)
					{
						settext(T_FORMDESIGNER_GUILIBRARY)
						#"GUI Library"
	...
	func CreateStatusBar  { 
		...
		{
			showmessage(T_FORMDESIGNER_READY,0)
			#"Ready!"
		}
		win.setstatusbar(status1)
	} 
	func CreateToolBar  { 
		aBtns = [ new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/new.png"))
			setclickevent(Method(:NewAction))
			settooltip(T_FORMDESIGNER_TOOLBAR_NEWFILE)
			#"New File"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/open.png"))
			...
			settooltip(T_FORMDESIGNER_TOOLBAR_OPENFILE)
			#"Open File"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/save.png"))
			...
			settooltip(T_FORMDESIGNER_TOOLBAR_SAVE)
			#"Save"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/saveas.png"))
			...
			settooltip(T_FORMDESIGNER_TOOLBAR_SAVEAS)
			#"Save As"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/duplicate.png"))
			setclickevent(Method(:Duplicate))
			settooltip(T_FORMDESIGNER_TOOLBAR_DUPLICATE)
			#"Duplicate"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/bring_to_front.png"))
			setclickevent(Method(:BringToFront))
			settooltip(T_FORMDESIGNER_TOOLBAR_BRINGTOFRONT)
			#"Bring to front"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/send_to_back.png"))
			setclickevent(Method(:SendToBack))
			settooltip(T_FORMDESIGNER_TOOLBAR_SENDTOBACK)
			#"Send to back"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/delete.png"))
			setclickevent(Method(:DeleteControl))
			settooltip(T_FORMDESIGNER_TOOLBAR_DELETE)
			#"Delete"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/selectobjects.png"))
			setclickevent(Method(:SelectObjectsWindow))
			settooltip(T_FORMDESIGNER_TOOLBAR_SELECTOBJECTS)
			#"Select Objects"
		}
		, new qtoolbutton(win) {
			setbtnimage(self,AppFile("image/close.png"))
			setclickevent(Method(:ExitAction))
			settooltip(T_FORMDESIGNER_TOOLBAR_EXIT)
			#"Exit"
		}
		]
		tool1 = win.addtoolbar("files") {
			for x in aBtns step 1 { 
				addwidget(x)
				addseparator()
			} 
		}
	...
	func CreateToolBox  { 
		if T_LAYOUTDIRECTION { 
			aToolBoxTextList = [:Lock = this.TextSize(T_FROMDESIGNER_TOOLBOX_LOCK,30),:Select = this.TextSize(T_FROMDESIGNER_TOOLBOX_SELECT,35),:Label = this.TextSize(T_FROMDESIGNER_TOOLBOX_LABEL,35),:Button = this.TextSize(T_FROMDESIGNER_TOOLBOX_BUTTON,32),:LineEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_LINEEDIT,32),:TextEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_TEXTEDIT,32),:ListWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_LISTWIDGET,32),:CheckBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_CHECKBOX,32),:Image = this.TextSize(T_FROMDESIGNER_TOOLBOX_IMAGE,32),:Slider = this.TextSize(T_FROMDESIGNER_TOOLBOX_SLIDER,30),:ProgressBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_PROGRESSBAR,32),:SpinBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_SPINBOX,35),:ComboBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_COMBOBOX,35),:DateTimeEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_DATETIMEEDIT,45),:TableWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TABLEWIDGET,35),:TreeWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TREEWIDGET,32),:RadioButton = this.TextSize(T_FROMDESIGNER_TOOLBOX_RADIOBUTTON,40),:WebView = this.TextSize(T_FROMDESIGNER_TOOLBOX_WEBVIEW,35),:DialSlider = this.TextSize(T_FROMDESIGNER_TOOLBOX_DIALSLIDER,35),:VideoWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_VIDEOWIDGET,35),:Frame = this.TextSize(T_FROMDESIGNER_TOOLBOX_FRAME,35),:LCDNumber = this.TextSize(T_FROMDESIGNER_TOOLBOX_LCDNUMBER,40),:HyperLink = this.TextSize(T_FROMDESIGNER_TOOLBOX_HYPERLINK,35),:Timer = this.TextSize(T_FROMDESIGNER_TOOLBOX_TIMER,35),:AllEvents = this.TextSize(T_FROMDESIGNER_TOOLBOX_ALLEVENTS,40),:Layout = this.TextSize(T_FROMDESIGNER_TOOLBOX_LAYOUT,35),:TabWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TABWIDGET,35),:StatusBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_STATUSBAR,35),:ToolBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_TOOLBAR,35)]
			else
				aToolBoxTextList = [:Lock = this.TextSize(T_FROMDESIGNER_TOOLBOX_LOCK,20),:Select = this.TextSize(T_FROMDESIGNER_TOOLBOX_SELECT,20),:Label = this.TextSize(T_FROMDESIGNER_TOOLBOX_LABEL,20),:Button = this.TextSize(T_FROMDESIGNER_TOOLBOX_BUTTON,18),:LineEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_LINEEDIT,19),:TextEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_TEXTEDIT,19),:ListWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_LISTWIDGET,18),:CheckBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_CHECKBOX,18),:Image = this.TextSize(T_FROMDESIGNER_TOOLBOX_IMAGE,19),:Slider = this.TextSize(T_FROMDESIGNER_TOOLBOX_SLIDER,21),:ProgressBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_PROGRESSBAR,17),:SpinBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_SPINBOX,19),:ComboBox = this.TextSize(T_FROMDESIGNER_TOOLBOX_COMBOBOX,16),:DateTimeEdit = this.TextSize(T_FROMDESIGNER_TOOLBOX_DATETIMEEDIT,17),:TableWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TABLEWIDGET,17),:TreeWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TREEWIDGET,17),:RadioButton = this.TextSize(T_FROMDESIGNER_TOOLBOX_RADIOBUTTON,17),:WebView = this.TextSize(T_FROMDESIGNER_TOOLBOX_WEBVIEW,17),:DialSlider = this.TextSize(T_FROMDESIGNER_TOOLBOX_DIALSLIDER,20),:VideoWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_VIDEOWIDGET,17),:Frame = this.TextSize(T_FROMDESIGNER_TOOLBOX_FRAME,20),:LCDNumber = this.TextSize(T_FROMDESIGNER_TOOLBOX_LCDNUMBER,15),:HyperLink = this.TextSize(T_FROMDESIGNER_TOOLBOX_HYPERLINK,19),:Timer = this.TextSize(T_FROMDESIGNER_TOOLBOX_TIMER,20),:AllEvents = this.TextSize(T_FROMDESIGNER_TOOLBOX_ALLEVENTS,20),:Layout = this.TextSize(T_FROMDESIGNER_TOOLBOX_LAYOUT,20),:TabWidget = this.TextSize(T_FROMDESIGNER_TOOLBOX_TABWIDGET,18),:StatusBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_STATUSBAR,20),:ToolBar = this.TextSize(T_FROMDESIGNER_TOOLBOX_TOOLBAR,20)]
		} 
		oToolBox = new qWidget()
		{
			...
			{
				setText(aToolBoxTextList[:Select])
				#"Select"
			...
			{
				setText(aToolBoxTextList[:Label])
				#"Label"
			...
			{
				setText(aToolBoxTextList[:Button])
				#"Button"
			...
			{
				setText(aToolBoxTextList[:LineEdit])
				#"LineEdit"
			...
			{
				setText(aToolBoxTextList[:TextEdit])
				#"TextEdit"
			...
			{
				setText(aToolBoxTextList[:ListWidget])
				#"ListWidget"
			...
			{
				setText(aToolBoxTextList[:CheckBox])
				#"Checkbox"
			...
			{
				setText(aToolBoxTextList[:Image])
				#"Image"
			...
			{
				setText(aToolBoxTextList[:Slider])
				#"Slider"
			...
			{
				setText(aToolBoxTextList[:ProgressBar])
				#"Progressbar"
			...
			{
				setText(aToolBoxTextList[:SpinBox])
				#"SpinBox"
			...
			{
				setText(aToolBoxTextList[:ComboBox])
				#"ComboBox"
			...
			{
				setText(aToolBoxTextList[:DateTimeEdit])
				#"DateTimeEdit"
			...
			{
				setText(aToolBoxTextList[:TableWidget])
				#"TableWidget"
			...
			{
				setText(aToolBoxTextList[:TreeWidget])
				#"TreeWidget"
			...
			{
				setText(aToolBoxTextList[:RadioButton])
				#"RadioButton"
			...
			{
				setText(aToolBoxTextList[:WebView])
				#"WebView"
			...
			{
				setText(aToolBoxTextList[:DialSlider])
				#"Dial Slider"
			...
			{
				setText(aToolBoxTextList[:VideoWidget])
				#"Video Widget"
			...
			{
				setText(aToolBoxTextList[:Frame])
				#"Frame"
			...
			{
				setText(aToolBoxTextList[:LCDNumber])
				#"LCD Number"
			...
			{
				setText(aToolBoxTextList[:HyperLink])
				#"HyperLink"
			...
			{
				setText(aToolBoxTextList[:Timer])
				#"Timer"
			...
			{
				setText(aToolBoxTextList[:AllEvents])
				#"All Events"
			...
			{
				setText(aToolBoxTextList[:Layout])
				#"Layout"
			...
			{
				setText(aToolBoxTextList[:TabWidget])
				#"Tab Widget"
			...
			{
				setText(aToolBoxTextList[:StatusBar])
				#"Statusbar"
			...
			{
				setText(aToolBoxTextList[:ToolBar])
				#"Toolbar"
		...
		{
			setLayoutDirection(0)
			setWindowTitle(T_FROMDESIGNER_TOOLBOX_WINDOWTITLE)
			#"ToolBox"
			setWidget(oScroll)
		}
		if T_LAYOUTDIRECTION { 
	...
	func CreatePropertiesWidget  { 
		oProperties = new qWidget()
		{
			...
			{
				setText(T_FROMDESIGNER_PROPERTIES_OBJECT)
				#"Object"
				if isMobile() { 
					setMaximumWidth(200)
					else
	...
	func PreparePropertiesTable oTable { 
		oTable {
			...
			setHorizontalHeaderItem(0, new QTableWidgetItem(T_FROMDESIGNER_PROPERTIES_PROPERTY))
			#"Property"
			setHorizontalHeaderItem(1, new QTableWidgetItem(T_FROMDESIGNER_PROPERTIES_VALUE))
			#"Value"
	...
	func CreatePropertiesDock  { 
		...
		{
			setLayoutDirection(0)
			setWindowTitle(T_FROMDESIGNER_PROPERTIES_WINDOWTITLE)
			#"Properties"
