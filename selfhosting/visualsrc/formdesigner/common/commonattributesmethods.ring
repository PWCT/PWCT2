...
class CommonAttributesMethods
	...
	func AddObjectCommonProperties oDesigner { 
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_NAME,False)
		#"Name"
		...
		#"Height"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_TEXTCOLOR,True)
		#"Text Color"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_BACKCOLOR,True)
		#"Back Color"
		oDesigner.oView.AddProperty(T_FORMDESIGNER_ATTRIBUTE_FONT,True)
		#"Font"
	} 
	...
	func DisplayCommonProperties oDesigner { 
		...
		#Set the Name
		oPropertiesTable.item(0,1).settext(oDesigner.oModel.GetObjectName(self))
		#Set the X
	...
	func GenerateCode oDesigner { 
		cOutput = char(9)+char(9)+oDesigner.oModel.GetObjectName(self)+" = "+'new #{f1}(#{f10}) {
					move(#{f2},#{f3})
					resize(#{f4},#{f5})
