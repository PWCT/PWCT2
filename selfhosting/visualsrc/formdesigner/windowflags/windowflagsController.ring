...
class windowflagscontroller from windowsControllerParent
	...
	aTypeList = ["Qt_Window","Qt_dialog","Qt_sheet","Qt_Drawer","Qt_popup","Qt_Tool","Qt_ToolTip","Qt_SplashScreen"]
	aHintsList = ["Qt_WindowTitleHint","Qt_WindowSystemMenuHint","Qt_WindowMinimizeButtonHint","Qt_WindowMaximizeButtonHint","Qt_WindowCloseButtonHint","Qt_WindowContextHelpButtonHint","Qt_WindowShadeButtonHint","Qt_WindowStaysOnTopHint","Qt_WindowStaysOnBottomHint","Qt_CustomizeWindowHint"]
	cFlags = ""
	#The window output
	nPropertyIndex = 6
	...
	func OkAction  { 
		...
		for x = 1 to len(aHintsList) step 1 { 
