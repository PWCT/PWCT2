...
class UndoController
	...
	func AddToHistory oGDController { 
		...
		aHistory+[oGDController.oModel.oStepsTreeModel.GetData(),oGDController.oModel.oInteractionModel.GetData(),oGDController.oModel.oStepsTreeModel.GetID(),oGDController.oModel.oInteractionModel.GetID()]
