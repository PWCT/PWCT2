...
class checkosComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value)+" = "+T_CT_CHECKOS_ST_VALUE+StyleData(T_CT_CHECKOS_IP_VALUE2LIST[Variable(:Value2)]))
...
class checkosComponentView from ComponentViewParent
	...
	ListBox(T_CT_CHECKOS_IP_VALUE2,:value2,T_CT_CHECKOS_IP_VALUE2LIST)
	PageButtons()
private
