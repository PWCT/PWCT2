...
T_CT_TEMPLATES_IP_VALUELIST = ["Hello World","Say Hello","Variables","Deep Copy","Implicit Conversion","Operators Precedence","Loop and Condition","Main Menu","Dynamic Loop","Modify lists using Loop","Exit from two loops","The Loop Command","Short-circuit evaluation","Using Functions","Variables Scope"]
