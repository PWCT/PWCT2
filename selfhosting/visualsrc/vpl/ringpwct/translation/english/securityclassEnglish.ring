...
T_CT_SECURITYCLASS_IP_VALUE2LIST = ["decrypt(cString,cKey,cIV) --> String","encrypt(cString,cKey,cIV) --> String","md5(cString) --> String","randbytes(nSize) --> String","sha1(cString --> String)","sha224(cString) --> String","sha256(cString) --> String","sha384(cString) --> String","sha512(cString) --> String"]
T_CT_SECURITYCLASS_IP_VALUE3 = "Parameters"
T_CT_SECURITYCLASS_IP_VALUE4 = "Output"
