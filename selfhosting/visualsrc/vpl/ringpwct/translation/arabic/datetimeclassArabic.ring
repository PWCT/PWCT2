...
T_CT_DATETIMECLASS_IP_VALUE2FUNC = ["adddays","clock","date","diffdays","time","timelist"]
#Copy the list to support changing the generated method name in the Steps Tree
T_CT_DATETIMECLASS_IP_VALUE2STEPFUNC = ["اضافة_ايام","ساعة","تاريخ","فرق_ايام","وقت","قائمة_الوقت"]
#/*
...
#]
#*/
T_CT_DATETIMECLASS_IP_VALUE2LIST = ["اضافة_ايام(تاريخ,عدد_الايام) --> سلسلة","ساعة() --> رقم","تاريخ() --> سلسلة","فرق_ايام(تاريخ1,تاريخ2) --> سلسلة","وقت() --> سلسلة","قائمة_الوقت() --> قائمة"]
