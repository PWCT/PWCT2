...
T_CT_INTERNETCLASS_IP_VALUE2STEPFUNC = ["تحميل","ارسال_بريد_الكتروني"]
#/*
...
#]
#*/
T_CT_INTERNETCLASS_IP_VALUE2LIST = ["تحميل(رابط) --> سلسلة","ارسال_بريد_الكتروني(خادم_SMTP,البريد_الالكتروني,كلمة_المرور,المرسل,المستلم,نسخة,عنوان,محتوى)"]
