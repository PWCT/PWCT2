...
#]
#*/
T_CT_QHBOXLAYOUTCLASS_IP_VALUE2LIST = ["فعل (لا شىء) --> صحيح","أضف تخطيط (تخطيط كيو) --> لا شىء","أضف عنصر فاصل (عنصر فاصل كيو) --> لا شىء","أضف تباعد (حجم صحيح) --> لا شىء","أضف تمدد (تمدد صحيح) --> لا شىء","أضف دعامة (حجم صحيح) --> لا شىء","أضف عنصر واجهة مستخدم (عنصر واجهة مستخدم كيو) --> لا شىء","منع الإشارات (منع صحيح) --> صحيح","أطفال (لا شىء) --> قائمة كائنات","أقرب حجم مقبول (عنصر واجهة مستخدم كيو، حجم كيو) --> حجم كيو","هوامش المحتويات (لا شىء) --> هوامش كيو","مستطيل المحتويات (لا شىء) --> مستطيل كيو","احذف (لا شىء) --> لا شىء","احذف لاحقاً (لا شىء) --> لا شىء","اتجاه (لا شىء) --> اتجاه تخطيط كيو","تفريغ معلومات الكائن (لا شىء) --> لا شىء","تفريغ شجرة الكائن (لا شىء) --> لا شىء","احصل على هوامش المحتويات (يسار صحيح، أعلى صحيح، يمين صحيح، أسفل صحيح) --> لا شىء","يرث (اسم الفئة حرف) --> صحيح","بدء (الأب) --> كائن","إدراج تخطيط (مؤشر صحيح، تخطيط كيو، تمدد صحيح) --> لا شىء","إدراج عنصر فاصل (مؤشر صحيح، عنصر فاصل كيو) --> لا شىء","إدراج تباعد (مؤشر صحيح، حجم صحيح) --> لا شىء","إدراج تمدد (مؤشر صحيح، تمدد صحيح) --> لا شىء","إدراج عنصر واجهة مستخدم (مؤشر صحيح، عنصر واجهة مستخدم كيو، تمدد صحيح، محاذاة كيو) --> لا شىء","تثبيت مرشح الحدث (كائن مرشح كيو) --> لا شىء","ممكّن (لا شىء) --> صحيح","نوع عنصر واجهة مستخدم (لا شىء) --> صحيح","إيقاف المؤقت (معرّف صحيح) --> لا شىء","شريط القوائم (لا شىء) --> عنصر واجهة مستخدم كيو","نقل إلى الخيط (خيط كيو الهدف) --> لا شىء","اسم الكائن (لا شىء) --> سلسلة كيو","مؤشر الكائن (لا شىء) --> مؤشر","الأب (لا شىء) --> كائن كيو","واجهة مستخدم الأب (لا شىء) --> عنصر واجهة مستخدم كيو","خاصية (اسم حرف) --> متغير كيو","إزالة مرشح الحدث (كائن كيو) --> لا شىء","إزالة عنصر (عنصر تخطيط كيو) --> لا شىء","إزالة واجهة مستخدم (عنصر واجهة مستخدم كيو) --> لا شىء","تعيين المحاذاة (عنصر واجهة مستخدم كيو، محاذاة كيو) --> صحيح","تعيين المحاذاة ٢ (محاذاة كيو) --> لا شىء","تعيين المحاذاة ٣ (تخطيط كيو، محاذاة كيو) --> صحيح","تعيين هوامش المحتويات (يسار صحيح، أعلى صحيح، يمين صحيح، أسفل صحيح) --> لا شىء","تعيين هوامش المحتويات ٢ (هوامش كيو) --> لا شىء","تعيين الاتجاه (اتجاه تخطيط كيو) --> لا شىء","تعيين ممكّن (تمكين صحيح) --> لا شىء","تعيين شريط القوائم (عنصر واجهة مستخدم كيو) --> لا شىء","تعيين اسم الكائن (سلسلة كيو) --> لا شىء","تعيين الأب (كائن كيو) --> لا شىء","تعيين خاصية (اسم حرف، متغير كيو) --> صحيح","تعيين خاصية ٢ (اسم حرف، صحيح) --> صحيح","تعيين خاصية ٣ (اسم حرف، عائم) --> صحيح","تعيين خاصية ٤ (اسم حرف، مزدوج) --> صحيح","تعيين خاصية ٥ (اسم حرف، سلسلة كيو) --> صحيح","تعيين خاصية مزدوجة (اسم حرف، مزدوج) --> صحيح","تعيين خاصية عائمة (اسم حرف، عائم) --> صحيح","تعيين خاصية صحيحة (اسم حرف، صحيح) --> صحيح","تعيين خاصية سلسلة (اسم حرف، سلسلة كيو) --> صحيح","تعيين قيود الحجم (قيد الحجم كيو) --> لا شىء","تعيين التباعد (تباعد صحيح) --> لا شىء","تعيين التمدد (مؤشر صحيح، تمدد صحيح) --> لا شىء","تعيين عامل التمدد (عنصر واجهة مستخدم كيو، تمدد صحيح) --> صحيح","تعيين عامل التمدد ٢ (تخطيط كيو، تمدد صحيح) --> صحيح","حظر الإشارات (لا شىء) --> صحيح","قيد الحجم (لا شىء) --> قيد الحجم كيو","التباعد (لا شىء) --> صحيح","بدء المؤقت (فترة صحيحة) --> صحيح","التمدد (مؤشر صحيح) --> صحيح","الخيط (لا شىء) --> خيط كيو","تحديث (لا شىء) --> لا شىء"]
