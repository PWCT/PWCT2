...
class expressionComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		switch Variable(:Value2) { 
			case 1
				#Call Function
				NewParentStep(T_CT_EXPRESSION_ST_CALLFUNC+StyleData(Variable(:Value))+T_CT_EXPRESSION_ST_FUNCCALLSTART)
...
class expressionComponentView from ComponentViewParent
	...
	ListBox(T_CT_EXPRESSION_IP_VALUE2,:value2,T_CT_EXPRESSION_IP_VALUE2LIST)
	PageButtons()
private
