...
class qprogressbarclassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFuncName = T_CT_QPROGRESSBARCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class qprogressbarclassComponentView from ComponentViewParent
	...
	ListBox(T_CT_QPROGRESSBARCLASS_IP_VALUE2,:value2,T_CT_QPROGRESSBARCLASS_IP_VALUE2LIST)
