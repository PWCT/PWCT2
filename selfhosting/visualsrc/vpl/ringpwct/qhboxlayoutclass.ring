...
class qhboxlayoutClassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFunc = T_CT_QHBOXLAYOUTCLASS_IP_VALUE2FUNC[Variable(:Value2)]
		#Get the function Name
		cFuncName = T_CT_QHBOXLAYOUTCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class qhboxlayoutClassComponentView from ComponentViewParent
	...
	ListBox(T_CT_QHBOXLAYOUT_IP_VALUE2,:value2,T_CT_QHBOXLAYOUTCLASS_IP_VALUE2LIST)
