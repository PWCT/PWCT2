...
class qlineeditclassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFuncName = T_CT_QLINEEDITCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class qlineeditclassComponentView from ComponentViewParent
	...
	TextBoxValue(T_CT_QLINEEDITCLASS_IP_VALUE,:value,T_CT_QLINEEDITCLASS_IP_VALUE_STARTVALUE)
	ListBox(T_CT_QLINEEDITCLASS_IP_VALUE2,:value2,T_CT_QLINEEDITCLASS_IP_VALUE2LIST)
