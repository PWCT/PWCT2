...
class newqprogressbarComponentView from ComponentViewParent
	...
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE,:value,T_CT_NEWQPROGRESSBAR_IP_VALUE_DEFAULT)
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE2,:value2,"10")
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE3,:value3,"10")
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE4,:value4,"100")
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE5,:value5,"30")
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE6,:value6,C_INTERACTIONPAGE_EXPCONTAINSLITERAL)
	TextBoxValue(T_CT_NEWQPROGRESSBAR_IP_VALUE7,:value7,T_CT_NEWQPROGRESSBAR_IP_VALUE7_DEFAULT)
	PageButtons()
private
