...
class numbersandbytesComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value3)+" = "+T_CT_NUMBERSANDBYTES_ST_VALUE+StepData(:Value)+T_CT_NUMBERSANDBYTES_ST_VALUE2+StyleData(T_CT_NUMBERSANDBYTES_IP_VALUE2LIST[Variable(:Value2)]))
...
class numbersandbytesComponentView from ComponentViewParent
	...
	ListBox(T_CT_NUMBERSANDBYTES_IP_VALUE2,:value2,T_CT_NUMBERSANDBYTES_IP_VALUE2LIST)
