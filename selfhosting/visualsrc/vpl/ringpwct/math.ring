...
class mathComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value3)+" = "+StyleData(T_CT_MATH_IP_VALUE2STEPFUNC[Variable(:Value2)])+T_CT_MATH_ST_VALUE+StepData(:Value)+T_CT_MATH_ST_VALUE2)
...
class mathComponentView from ComponentViewParent
	...
	ListBox(T_CT_MATH_IP_VALUE2,:value2,T_CT_MATH_IP_VALUE2LIST)
