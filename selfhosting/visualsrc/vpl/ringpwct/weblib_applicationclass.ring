...
class weblib_applicationclassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFuncName = T_CT_WEBLIB_APPLICATIONCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class weblib_applicationclassComponentView from ComponentViewParent
	...
	ListBox(T_CT_WEBLIB_APPLICATIONCLASS_IP_VALUE2,:value2,T_CT_WEBLIB_APPLICATIONCLASS_IP_VALUE2LIST)
