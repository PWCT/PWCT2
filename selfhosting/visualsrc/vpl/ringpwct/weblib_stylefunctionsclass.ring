...
class weblib_stylefunctionsclassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFuncName = T_CT_WEBLIB_STYLEFUNCTIONSCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class weblib_stylefunctionsclassComponentView from ComponentViewParent
	...
	ListBox(T_CT_WEBLIB_STYLEFUNCTIONSCLASS_IP_VALUE2,:value2,T_CT_WEBLIB_STYLEFUNCTIONSCLASS_IP_VALUE2LIST)
