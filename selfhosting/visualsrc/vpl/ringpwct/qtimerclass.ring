...
class qtimerclassComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		cFunc = T_CT_QTIMERCLASS_IP_VALUE2FUNC[Variable(:Value2)]
		#Get the function Name
		cFuncName = T_CT_QTIMERCLASS_IP_VALUE2STEPFUNC[Variable(:Value2)]
...
class qtimerclassComponentView from ComponentViewParent
	...
	TextBoxValue(T_CT_QTIMERCLASS_IP_VALUE,:value,T_CT_QTIMERCLASS_IP_VALUE_STARTVALUE)
	ListBox(T_CT_QTIMERCLASS_IP_VALUE2,:value2,T_CT_QTIMERCLASS_IP_VALUE2LIST)
