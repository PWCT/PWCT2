...
class CallFuncComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(T_CT_CALLFUNC_ST_CALLFUNC+cOutputEqual+Variable(:Name)+T_CT_CALLFUNC_ST_FUNCCALLSTART+cParametersData+T_CT_CALLFUNC_ST_FUNCCALLEND)
		SetStepCode(cOutputEqual+Variable(:Name)+"("+cParameters+")")
		return True
	} 
private
