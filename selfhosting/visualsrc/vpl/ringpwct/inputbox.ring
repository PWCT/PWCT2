...
class inputboxComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value4)+" = "+T_CT_INPUTBOX_ST_VALUE+StepData(:Value)+T_CT_INPUTBOX_ST_VALUE2+StyleData(T_CT_INPUTBOX_IP_VALUE2LIST[Variable(:Value2)])+T_CT_INPUTBOX_ST_VALUE3+StepData(:Value3))
...
class inputboxComponentView from ComponentViewParent
	...
	ListBox(T_CT_INPUTBOX_IP_VALUE2,:value2,T_CT_INPUTBOX_IP_VALUE2LIST)
