...
class conversionComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value3)+" = "+T_CT_CONVERSION_ST_VALUE+StepData(:Value)+T_CT_CONVERSION_ST_VALUE2+StyleData(T_CT_CONVERSION_IP_VALUE2LIST[Variable(:Value2)]))
...
class conversionComponentView from ComponentViewParent
	...
	ListBox(T_CT_CONVERSION_IP_VALUE2,:value2,T_CT_CONVERSION_IP_VALUE2LIST)
