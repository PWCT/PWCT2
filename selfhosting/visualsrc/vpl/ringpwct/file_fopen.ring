...
class file_fopenComponentController from ComponentControllerParent
	...
	func GenerateAction  { 
		...
		NewStep(StepData(:Value3)+" = "+T_CT_FILE_FOPEN_ST_VALUE+StepData(:Value)+T_CT_FILE_FOPEN_ST_VALUE2+StyleData(T_CT_FILE_FOPEN_IP_VALUE2LIST[Variable(:value2)]))
...
class file_fopenComponentView from ComponentViewParent
	...
	ListBox(T_CT_FILE_FOPEN_IP_VALUE2,:value2,T_CT_FILE_FOPEN_IP_VALUE2LIST)
