...
class componentwizardController from windowsControllerParent
	...
	aQuickScripts = ["NewStep(  )
	SetStepCode(  )","NewParentStep(  )
		SetStepCode(  )
		AllowInteraction()
	...
	func GenerateCode  { 
		...
		switch oView.ListTemplate.currentrow() { 
			...
			case 9
				#Textbox-Listbox-Textbox-Textbox
	...
	func ChangeTemplate  { 
		switch oView.listTemplate.currentrow() { 
			case 1
				#Empty File
				cText = "Interaction Page - Title"+WindowsNL()+"Steps Tree Constants"
			case 2
				#Empty Page
				cText = "Interaction Page - Title"+WindowsNL()+"Steps Tree Constants"
			case 3
				#One Textbox
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Steps Tree Constants"
			case 4
				#Two Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Steps Tree Constants"
			case 5
				#Three Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Steps Tree Constants"
			case 6
				#Four Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Steps Tree Constants"
			case 7
				#Five Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Label 5 (Textbox 5)"+WindowsNL()+"Steps Tree Constants"
			case 8
				#Textbox - Listbox - Textbox
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Listbox)"+WindowsNL()+"Listbox Items as List"+WindowsNL()+"Third Label (Textbox)"+WindowsNL()+"Steps Tree Constants"
			case 9
				#Textbox - Listbox - Textbox - Textbox
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Listbox)"+WindowsNL()+"Listbox Items as List"+WindowsNL()+"Third Label (Textbox)"+WindowsNL()+"Label 4 (Textbox)"+WindowsNL()+"Steps Tree Constants"
			case 10
				#6 Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Label 5 (Textbox 5)"+WindowsNL()+"Label 6 (Textbox 6)"+WindowsNL()+"Steps Tree Constants"
			case 11
				#7 Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Label 5 (Textbox 5)"+WindowsNL()+"Label 6 (Textbox 6)"+WindowsNL()+"Label 7 (Textbox 7)"+WindowsNL()+"Steps Tree Constants"
			case 12
				#8 Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Label 5 (Textbox 5)"+WindowsNL()+"Label 6 (Textbox 6)"+WindowsNL()+"Label 7 (Textbox 7)"+WindowsNL()+"Label 8 (Textbox 8)"+WindowsNL()+"Steps Tree Constants"
			case 13
				#9 Textboxes
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (First Textbox)"+WindowsNL()+"Second Label (Second Textbox)"+WindowsNL()+"Third Label (Third Textbox)"+WindowsNL()+"Label 4 (Textbox 4)"+WindowsNL()+"Label 5 (Textbox 5)"+WindowsNL()+"Label 6 (Textbox 6)"+WindowsNL()+"Label 7 (Textbox 7)"+WindowsNL()+"Label 8 (Textbox 8)"+WindowsNL()+"Label 9 (Textbox 9)"+WindowsNL()+"Steps Tree Constants"
			case 14
				#One Listbox
				cText = "Interaction Page - Title"+WindowsNL()+"First Label (Listbox)"+WindowsNL()+"Listbox Items as List"+WindowsNL()+"Steps Tree Constants"
		} 
	...
	func FunctionCall  { 
		...
		cCode = "NewStep( #{f1}  )"+WindowsNL()+"SetStepCode( #{f2} )"+WindowsNL()
		cStepName = ""
		cStepCode = ""
		...
		if nParaCount > 0 { 
			...
			for x = 1 to nParaCount step 1 { 
				...
				cStepName += " +  T_CT_"+cComponent+"_ST_VALUE"
				cStepCode += "Variable(:Value) + ' = ' + "+'"'+cFuncName+"()"+'"'
		} 
	...
	func ClassMethodsListbox  { 
		...
		cCode = "
				...
				"
		cCode = substr(cCode,"#{f1}",cComponent)
		oView.TextStepsTree.insertplaintext(cCode)
