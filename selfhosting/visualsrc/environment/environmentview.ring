...
class EnvironmentView from WindowsViewParent
	...
	func CreateMenuBar win { 
		...
		{
			subFile = addmenu(T_ENV_MENU_FILE)
			#"File"
			subEdit = addmenu(T_ENV_MENU_EDIT)
			#"Edit"
			subView = addmenu(T_ENV_MENU_VIEW)
			#"View"
			subProgram = addmenu(T_ENV_MENU_PROGRAM)
			#"Program"
			if  NOT PWCTIsMobile(:ToolsDistributeMenu) { 
				subTools = addmenu(T_ENV_MENU_TOOLS)
				#"Tools"
				if this.lShowDistributeMenu { 
					subDistribute = addmenu(T_ENV_MENU_DISTRIBUTE)
					#"Distribute"
				} 
			} 
			...
			subHelp = addmenu(T_ENV_MENU_HELP)
			#"Help"
			subFile {
			...
			subEdit {
				...
				oAction = new qAction(win)
				{
					...
					setbtnimage(self,AppFile("images/search.png"))
					settext(T_ENV_MENU_FINDREPLACE)
					#"Find and Replace"
				...
				oAction = new qAction(win)
				{
					...
					settext(T_ENV_MENU_CUSTOMIZATION)
					#"Customization"
			...
			subView {
				if !isWebAssembly() { 
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_PROJECTFILES)
						#"Project Files"
				...
				oAction = new qAction(win)
				{
					...
					settext(T_ENV_MENU_GOALDESIGNER)
					#"Goal Designer"
				}
				addaction(oAction)
				addseparator()
				oAction = new qAction(win)
				{
					...
					settext(T_ENV_MENU_OUTPUTWINDOW)
					#"Output Window"
				}
				addaction(oAction)
				addseparator()
				oAction = new qAction(win)
				{
					...
					settext(T_ENV_MENU_FORMDESIGNERWINDOW)
					#"Form Designer"
				}
				addaction(oAction)
				addseparator()
				subApperance = addmenu(T_ENV_MENU_APPEARANCE)
				#"Appearance"
				subApperance {
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_FILESTOOLBAR)
						#"Files ToolBar"
					}
					addaction(oAction)
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MAINFILETOOLBAR)
						#"Main File ToolBar"
					}
					addaction(oAction)
					oAction = new qAction(win)
				...
				addseparator()
				subStyle = addmenu(T_ENV_MENU_MODE)
				#"Mode"
				subStyle {
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_GENERAL)
						#"General (All Windows)"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_TESTING)
						#"General (Testing)"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_PROGRAMMING_ALL_LEFT)
						#"Programming (All Windows) - Left"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_PROGRAMMING_ALL_RIGTH)
						#"Programming (All Windows) - Right"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_PROGRAMMING_GOALDESIGNER)
						#"Programming (Goal Designer)"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_MODE_GUI)
						#"GUI Development (Goal Designer + Form Designer)"
					}
					addaction(oAction)
				}
				addseparator()
				subStyle = addmenu(T_ENV_MENU_STYLE)
				#"Style"
				subStyle {
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEWINDOWS)
						#"Windows"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEWINDOWSBLOCKS)
						#"Windows - Blocks"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONWHITE)
						#"Fusion: White"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONWHITEBLOCKS)
						#"Fusion: White Blocks"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONBLACK)
						#"Fusion: Black"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONMODERNBLACK)
						#"Fusion: Modern Black"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONSIMPLEBLACK)
						#"Fusion: Simple Black"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONBLACKBLOCKS)
						#"Fusion: Black Blocks"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONBLUE)
						#"Fusion: Blue"
					}
					addaction(oAction)
					addseparator()
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_STYLEFUSIONBLUE2)
						#"Fusion: Blue 2"
					}
					addaction(oAction)
				}
				if this.lShowLanguageMenu AND !PWCTIsMobile(:SelectLanguage) { 
					addseparator()
					subLang = addmenu(T_ENV_MENU_LANGUAGE)
					#"Language"
					subLang {
						oAction = new qAction(win)
						{
							...
							settext(T_ENV_MENU_LANG_ARABIC)
							#"Arabic"
						}
						addaction(oAction)
						addseparator()
						oAction = new qAction(win)
						{
							...
							settext(T_ENV_MENU_LANG_ENGLISH)
							#"English"
						}
						addaction(oAction)
					}
				...
				if PWCTIsMobile(:RunApplication) { 
					...
					addaction(oAction)
						...
						oAction = new qAction(win)
						{
							...
							setbtnimage(self,AppFile("images/rungui.png"))
							settext(T_ENV_MENU_RUNNOCONSOLE)
							#"Run GUI Application (No Console)"
							setclickevent(Method(:RunGUIAction))
						}
						addaction(oAction)
						if this.lShowWebOptions { 
							oAction = new qAction(win)
							{
								...
								settext(T_ENV_MENU_RUNWEBAPPLICATION)
								#"Run Web Application (Open In Browser)"
						...
						oAction = new qAction(win)
						{
							...
							settext(T_ENV_MENU_SETMAINFILE)
							#"Set the Main File to be the current source file"
						...
						oAction = new qAction(win)
						{
							...
							setbtnimage(self,AppFile("images/debug.png"))
							settext(T_ENV_MENU_MAINFILEDEBUG)
							#"Main File : Debug (Run then wait!)"
						...
						oAction = new qAction(win)
						{
							...
							setbtnimage(self,AppFile("images/run.png"))
							settext(T_ENV_MENU_MAINFILERUN)
							#"Main File : Run"
						...
						oAction = new qAction(win)
						{
							...
							setbtnimage(self,AppFile("images/rungui.png"))
							settext(T_ENV_MENU_MAINFILERUNGUI)
							#"Main File : Run GUI Application (No Console)"
						...
						if this.lShowWebOptions { 
							oAction = new qAction(win)
							{
								...
								setbtnimage(self,AppFile("images/web.png"))
								settext(T_ENV_MENU_MAINFILERUNWEB)
								#"Main File : Run Web Application (Open In Browser)"
			...
			if  NOT PWCTIsMobile(:ToolsDistributeMenu) { 
				subTools {
					oAction = new qAction(win)
					{
						settext(T_ENV_MENU_TOOLS_RINGNOTEPAD)
						#"Ring Notepad"
					...
					oAction = new qAction(win)
					{
						settext(T_ENV_MENU_TOOLS_FORMDESIGNER)
						#"Form Designer"
					...
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_TOOLS_RINGREPLCONSOLE)
						#"RingREPL - Console"
					...
					oAction = new qAction(win)
					{
						...
						settext(T_ENV_MENU_TOOLS_RINGREPLGUI)
						#"RingREPL - GUI"
						setclickEvent(Method(:REPLGUI))
					}
					addaction(oAction)
					addseparator()
					subOSTools = addmenu(T_ENV_MENU_TOOLS_OSTOOLS)
					#"Operating System Tools"
					subOSTools {
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_TOOLS_TERMINAL)
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_TOOLS_FM)
							#"Files Manager (Explorer)"
				...
				if this.lShowDistributeMenu { 
					subDistribute {
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE1)
							#"Generate Ring Object File (*.ringo)"
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE2)
							#"Ring2EXE (Build Console Application)"
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE3)
							#"Ring2EXE (Distribute Application - Use All Runtime)"
							setclickEvent(Method("Distribute(3)"))
						}
						addaction(oAction)
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE4)
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE5)
							#"Ring2EXE (Distribute RingQt Application)"
							setclickEvent(Method("Distribute(5)"))
						}
						addaction(oAction)
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE6)
							#"Ring2EXE (Distribute RingAllegro Game)"
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE9)
							#"Ring2EXE (Distribute Light RingQt Application)"
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE7)
							#"Ring2EXE (Prepare Qt Project - Distribute for Mobile Devices)"
						...
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_DIST_RING2EXE8)
							#"Ring2EXE (Prepare Qt Project - Distribute for Web using WebAssembly)"
			...
			if !T_LAYOUTDIRECTION { 
				subGames {
					aGamesTitles = ["Stars Fighter","Flappy Bird 3000","Super Man 2016","Snake","Escape","Tetris","Maze","Sokoban","Squares Puzzle","Gold Magic 800","Pairs","2048","Cards","Money Boxes","Knight Tour","Tessera","Matching","Othello"]
					aGamesSeparator = [3,8,10]
					subGames {
						for nGameIndex = 1 to len(aGamesTitles) step 1 { 
							oAction = new qAction(win)
							{
			...
			subHelp {
				if !PWCTIsMobile(:HelpMenu) { 
					...
					subHelpLF = addmenu(T_ENV_MENU_PWCTLANGREF)
					#"PWCT Language Reference"
					subHelpLF {
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_CHM)
							#"CHM File"
					...
					addseparator()
					subHelpLF = addmenu(T_ENV_MENU_LANGREF)
					#"Ring Language Reference"
					subHelpLF {
						oAction = new qAction(win)
						{
							settext(T_ENV_MENU_CHM)
				...
				subHelpTools = addmenu(T_ENV_MENU_DEVTOOLS)
				#"Development Tools"
				subHelpTools {
					oAction = new qAction(win)
					{
						settext(T_ENV_MENU_PROGLANG)
			...
			elseif PWCTIsMobile(:RunApplication)
				...
				if lNoRunInConsole { 
					...
					, new qToolbutton(win) {
						setbtnimage(self,AppFile("images/rungui.png"))
						setclickevent(Method(:RunGUIAction))
						settooltip(T_ENV_MENU_RUNNOCONSOLE)
						#"Run GUI Application (No Console)"
					}
					, new qtoolbutton(win) {
						setbtnimage(self,AppFile("images/web.png"))
	...
	func CreateMainFileToolbar win { 
		win {
			...
			this.oToolBarMainFile = addtoolbar("mainfile") {
				...
				{
					setText(T_ENV_TOOLBAR_MAINFILE)
					#"Main File : "
				}
				...
				oBtnSetFile = new qtoolbutton(this.win)
				{
					setbtnimage(self,AppFile("images/open.png"))
					setclickEvent(Method(:SetMainFile))
					settooltip(T_ENV_MENU_SETMAINFILE)
					#"Set the Main File to be the current source file (Ctrl+Shift+M)"
				...
				oBtnRunGUIMainFile = new qtoolbutton(this.win)
				{
					setbtnimage(self,AppFile("images/rungui.png"))
					setclickEvent(Method(:RunGUIMainFile))
					settooltip(T_ENV_MENU_MAINFILERUNGUI)
					#"Main File : Run GUI Application - No Console (Ctrl+Shift+F5)"
					this.MobileButtonSize(self)
				}
				...
				if  NOT PWCTISMobile(:MAINTOOLBAR) { 
					if !this.lNoRunInConsole { 
						oBtnDebugMainFile = new qtoolbutton(this.win)
						{
							setbtnimage(self,AppFile("images/debug.png"))
							setclickevent(Method(:DebugMainFile))
							settooltip(T_ENV_MENU_MAINFILEDEBUG)
							#"Main File : Debug  - Run then wait! (Ctrl+Shift+D)"
						}
						oBtnRunMainFile = new qtoolbutton(this.win)
						{
							setbtnimage(self,AppFile("images/run.png"))
							setclickEvent(Method(:RunMainFile))
							settooltip(T_ENV_MENU_MAINFILERUN)
							#"Main File : Run the program (Ctrl+Shift+R)"
						}
					...
					oBtnRunWebMainFile = new qtoolbutton(this.win)
					{
						setbtnimage(self,AppFile("images/web.png"))
						setclickEvent(Method(:RunInBrowserMainFile))
						settooltip(T_ENV_MENU_MAINFILERUNWEB)
						#"Main File : Run Web Application - Open In Browser (Ctrl+Shift+F6)"
					}
	...
	func CreateFilesManager win { 
		...
		oFilesTree = new TreeViewControl(win)
		{
			...
			for x = 1 to this.ofile.columncount() step 1 { 
				hidecolumn(x)
			} 
		...
		oFilesTreeWidget = new QWidget()
		{
			...
			{
				setTooltip(T_PROJECTFILES_EXPLORER)
				#"Explorer"
				setclickEvent(Method(:OSFilesManager))
				#this.mobileButtonSize(self)
			}
			...
			{
				setTooltip(T_PROJECTFILES_TERMINAL)
				#"Terminal"
				setclickEvent(Method(:OSTerminal))
				#this.mobileButtonSize(self)
			}
		...
		oDockFilesManager = new qdockwidget(win,0)
		{
			...
			setwindowtitle(T_ENV_DOCK_PROJECTFILES)
			#"Project Files"
		}
	...
	func CreateGoalDesigner win { 
		...
		oDock = new qdockwidget(win,0)
		{
			...
			setwindowtitle(T_ENV_DOCK_GOALDESIGNER)
			#"Goal Designer"		
