...
class EnvironmentController from WindowsControllerParent
	...
	func Start  { 
		...
		oView.oDockGoalDesigner.setWindowTitle(T_ENV_DOCK_GOALDESIGNER+" : "+parent().oVisualSourceFile.cFileName)
	...
	func prepareDockSize  { 
		aDocksData = [[oView.oDockOutputWindow,nOutputWindowWidth,nOutputWindowHeight],[oView.oDockGoalDesigner,nGoalDesignerWidth,nGoalDesignerHeight],[oView.oDockFilesManager,nFilesManagerWidth,nFilesManagerHeight],[oView.oDockComponentsBrowser,nComponentsBrowserWidth,nComponentsBrowserHeight]]
		aDocksData = sort(aDocksData,2)
		for oDockItem in aDocksData step 1 { 
	...
	func openVisualFile cFileName { 
		...
		if len(read(FileNameEncoding(cFileName))) < 50*1024 { 
		...
		if lOpenFilesInNewTabs OR len(aActiveFiles) > 0 { 
			...
			for item in aActiveFilesCopy step 1 { 
				item[2] = lower(item[2])
			} 
		...
		if  NOT lOpenFilesInNewTabs { 
			...
			if len(aActiveFiles) = 1 { 
				aActiveFiles = []
					...
					for x = 1 to len(aActiveFiles) step 1 { 
	...
	func ActiveGoalDesignerChanged  { 
		...
		for aItem in aActiveFiles step 1 { 
	...
	func PWCTOpenVideo nVideo { 
		aVideos = ["https://www.youtube.com/watch?v=zd2jUEIlr8Y&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7","https://www.youtube.com/watch?v=f9fbPKSiP4k&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=2","https://www.youtube.com/watch?v=GMlbc9bVIc0&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=3","https://www.youtube.com/watch?v=3yd72YrXxF0&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=4","https://www.youtube.com/watch?v=4KgNXz-DxcY&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=5","https://www.youtube.com/watch?v=OfzMfK_NukA&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=6","https://www.youtube.com/watch?v=gtL8m_-0F5o&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=7","https://www.youtube.com/watch?v=EVPwn6lgsDM&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=8","https://www.youtube.com/watch?v=rTJubpy7TiA&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=9","https://www.youtube.com/watch?v=8Q75DgY-m1s&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=10","https://www.youtube.com/watch?v=TtuWCah2FfY&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=11","https://www.youtube.com/watch?v=qLqIOlP90EY&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=12","https://www.youtube.com/watch?v=sLTrBXMYurw&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=13","https://www.youtube.com/watch?v=3hOFTkd0Ul8&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=14","https://www.youtube.com/watch?v=CPlyA9wo8RQ&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=15","https://www.youtube.com/watch?v=nnFKa4MShoE&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=16","https://www.youtube.com/watch?v=Bzd1Gkass5E&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=17","https://www.youtube.com/watch?v=kJXGIUoczXQ&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=18","https://www.youtube.com/watch?v=9KctZM6zmuA&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=19","https://www.youtube.com/watch?v=A9w4bOvQLBc&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=20","https://www.youtube.com/watch?v=LQdKeQRW2CM&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=21","https://www.youtube.com/watch?v=o88THX8766o&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=22","https://www.youtube.com/watch?v=zFhWc_k3MoI&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=23","https://www.youtube.com/watch?v=T6cXrW3Ob8M&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=24","https://www.youtube.com/watch?v=fceWa4_DvyQ&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=25","https://www.youtube.com/watch?v=cOdgpprb3_U&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=26","https://www.youtube.com/watch?v=kR5LCPPm89c&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=27","https://www.youtube.com/watch?v=ZC99W16KEJM&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=28","https://www.youtube.com/watch?v=d8GhoeTm1WE&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=29","https://www.youtube.com/watch?v=w2S48C2QXvw&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=30","https://www.youtube.com/watch?v=p3OP676l_W4&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=31","https://www.youtube.com/watch?v=0M1I2llBLrc&list=PLpQiqjcu7CuFFulJW0IdG8xmAXaDC2oC7&index=32"]
		new QDesktopServices
		{
	...
	func PWCTOpenGame nGame { 
		aGamesFiles = ["applications/StarsFighter/starsfighter.ring","applications/FlappyBird3000/flappybird3000.ring","applications/SuperMan2016/superman.ring","applications/Snake/snake.ring","applications/Escape/EscapeGame.ring","applications/Tetris/tetris.ring","applications/Maze/maze.ring","applications/Sokoban/sokoban.ring","applications/SquaresPuzzle/SquaresPuzzle.ring","applications/GoldMagic800/goldmagic800.ring","applications/Pairs/PairsGame.ring","applications/Game2048/game2048.ring","applications/Cards/cards.ring","applications/MoneyBoxes/moneyController.ring","applications/KnightTour/KnightTour.ring","applications/Tessera/tessera.ring","applications/Matching/MatchingGame.ring","applications/OthelloGame/OthelloGame.ring"]
	...
	func GUIAction  { 
		#"GUI Library"
		MsgBox(T_GUILIB_TITLE,T_GUILIB_INFO)
	...
	func AboutAction  { 
		#"About"
		MsgBox(T_ABOUT_TITLE,T_ABOUT_DEVELOPER)
		#"2022, PWCT Software
		#/*
	...
	func SaveSettings  { 
		...
		cSettings = "C_STEPCOLOR_COMMENT_TEXT = '"+C_STEPCOLOR_COMMENT_TEXT+"'"+nl+"C_STEPCOLOR_COMMENT_BACKCOLOR = '"+C_STEPCOLOR_COMMENT_BACKCOLOR+"'"+nl+"C_STEPCOLOR_ROOT_TEXT = '"+C_STEPCOLOR_ROOT_TEXT+"'"+nl+"C_STEPCOLOR_ROOT_BACKCOLOR = '"+C_STEPCOLOR_ROOT_BACKCOLOR+"'"+nl+"C_STEPCOLOR_ALLOWINTERACTION_TEXT = '"+C_STEPCOLOR_ALLOWINTERACTION_TEXT+"'"+nl+"C_STEPCOLOR_ALLOWINTERACTION_BACKCOLOR = '"+C_STEPCOLOR_ALLOWINTERACTION_BACKCOLOR+"'"+nl+"C_STEPCOLOR_INFO_TEXT = '"+C_STEPCOLOR_INFO_TEXT+"'"+nl+"C_STEPCOLOR_INFO_BACKCOLOR = '"+C_STEPCOLOR_INFO_BACKCOLOR+"'"+nl+"C_STEPCOLOR_DATA_TEXT = '"+C_STEPCOLOR_DATA_TEXT+"'"+nl+"C_STEPCOLOR_DATA_BACKCOLOR = '"+C_STEPCOLOR_DATA_BACKCOLOR+"'"+nl+"C_STEPSTREE_SELECTIONCOLOR = '"+C_STEPSTREE_SELECTIONCOLOR+"'"+nl+"C_STEPSTREE_SELECTIONBACKGROUND = '"+C_STEPSTREE_SELECTIONBACKGROUND+"'"+nl+"C_STEPSTREE_BACKCOLOR = '"+C_STEPSTREE_BACKCOLOR+"'"+nl+"C_STEPSTREE_SHOWLINES = "+C_STEPSTREE_SHOWLINES+nl+"C_STEPSTREE_AUTORUN = "+C_STEPSTREE_AUTORUN+nl+"C_STEPSTREE_INDENTATION = "+C_STEPSTREE_INDENTATION+nl+"C_STEPSTREE_OPENFILESINNEWTABS = "+C_STEPSTREE_OPENFILESINNEWTABS+nl+"C_STEPSTREE_OPENINTERACTIONSINNEWWINDOWS = "+C_STEPSTREE_OPENINTERACTIONSINNEWWINDOWS+nl+"C_STEPSTREE_SHOWTIMEMACHINE = "+C_STEPSTREE_SHOWTIMEMACHINE+nl+"C_STEPSTREE_AVOIDCOMPONENTSBROWSER = "+C_STEPSTREE_AVOIDCOMPONENTSBROWSER+nl+"C_STEPSTREE_AVOIDCOMPONENTSBROWSERAUTOCOMPLETE = "+C_STEPSTREE_AVOIDCOMPONENTSBROWSERAUTOCOMPLETE+nl+"C_STEPSTREE_COMPONENTSBROWSERALWAYSSHOWSEARCHWINDOW = "+C_STEPSTREE_COMPONENTSBROWSERALWAYSSHOWSEARCHWINDOW+nl+"C_STEPSTREE_LIGHTTREELINES = "+C_STEPSTREE_LIGHTTREELINES+nl+"C_STEPSTREE_ALLOWSYNTAXERRORS = "+C_STEPSTREE_ALLOWSYNTAXERRORS+nl+"C_STEPSTREE_NODEICON = "+C_STEPSTREE_NODEICON+nl+"C_STEPSTREE_HIDESTEPCODETAB = "+C_STEPSTREE_HIDESTEPCODETAB+nl+"C_PROPERTIES_REFLECTCHANGEINFONTSIZE = "+C_PROPERTIES_REFLECTCHANGEINFONTSIZE+nl+"C_PROPERTIES_BORDERSAROUNDSTEPS = "+C_PROPERTIES_BORDERSAROUNDSTEPS+nl+"C_COMPONENTSBROWSER_COLOR = '"+C_COMPONENTSBROWSER_COLOR+"'"+nl+"C_INTERACTIONPAGE_TITLECOLOR = '"+C_INTERACTIONPAGE_TITLECOLOR+"'"+nl+"C_INTERACTIONPAGE_TITLEBACKCOLOR = '"+C_INTERACTIONPAGE_TITLEBACKCOLOR+"'"+nl+"C_ENV_DEFAULT_STYLE = "+C_ENV_DEFAULT_STYLE+nl+"C_ENV_DEFAULT_MODE = "+C_ENV_DEFAULT_MODE+nl+"C_ENV_DEFAULT_LANG = "+C_ENV_DEFAULT_LANG+nl+"cFont = '"+cFont+"'"+nl+"nFontSize = "+nFontSize+nl+"lShowFilesManager = "+oView.oDockFilesManager.isvisible()+nl+"lShowGoalDesigner = "+oView.oDockGoalDesigner.isvisible()+nl+"lShowFormDesigner = "+oView.oDockFormDesigner.isvisible()+nl+"lShowOutputWindow = "+oView.oDockOutputWindow.isvisible()+nl+"lShowFilesToolBar = "+oView.oToolBarFiles.isvisible()+nl+"lShowMainFileToolBar = "+oView.oToolBarMainFile.isvisible()+nl+"lShowStatusBar = "+oView.oStatusBar.isvisible()+nl+"nOutputWindowWidth = "+oView.oDockOutputWindow.width()+nl+"nOutputWindowHeight = "+oView.oDockOutputWindow.height()+nl+"nFilesManagerWidth = "+oView.oDockFilesManager.width()+nl+"nFilesManagerHeight = "+oView.oDockFilesManager.height()+nl+"nComponentsBrowserWidth = "+oView.oDockComponentsBrowser.width()+nl+"nComponentsBrowserHeight = "+oView.oDockComponentsBrowser.height()+nl+"nGoalDesignerWidth = "+oView.oDockgoalDesigner.width()+nl+"nGoalDesignerHeight = "+oView.oDockgoalDesigner.height()+nl
	...
	func GenerateControllerClass cFileName { 
		...
		oVisualFile = new VisualSourceFile
		{
			...
			LoadTables()
			setfile(cFileName)
			for aInteraction in aInteractionsTable step 1 { 
				aInteraction[C_INTERACTIONRECORD_VARIABLESVALUES] = substr(aInteraction[C_INTERACTIONRECORD_VARIABLESVALUES],"filename_",cFormName)
			} 
			for aStep in aStepsTable step 1 { 
				aStep[C_TREEMODEL_CONTENT][:name] = substr(aStep[C_TREEMODEL_CONTENT][:name],"filename_",cFormName)
				aStep[C_TREEMODEL_CONTENT][:code] = substr(aStep[C_TREEMODEL_CONTENT][:code],"filename_",cFormName)
				aStep[C_TREEMODEL_CONTENT][:plainname] = substr(aStep[C_TREEMODEL_CONTENT][:plainname],"filename_",cFormName)
			} 
			open()
			createTables()
			SaveTables()
	...
	func SaveBeforeRunning  { 
		parent().oProgramController.prepare(parent())
		#Save before running
	} 
	func Distribute nOption { 
		...
		switch nOption { 
			...
			case 8
				#qt project webassembly
				cPara += ",-dist,-allruntime,-gui,-webassemblyqt"
			case 9
				#light guilib (QtCore, QtGui & QtWidgets)
				cPara += ",-dist,-gui,-lightguilib"
		} 
		oView.oDockOutputWindow {
			show()
			raise()
		}
	...
	func RunToolConsole cFileName { 
		if isWindows() { 
			...
			elseif isLinux()
				cCode = 'cd $(dirname "'+cFileName+'") ; x-terminal-emulator -e '+"'"+'ring "'+cFileName+'";'+"' &"+nl
				system(cCode)
			elseif isMacosx()
				cCode = 'cd $(dirname "'+cFileName+'") ; osascript -e '+`'tell application "Terminal" to do script "ring \"`+cFileName+`\" "'`
				system(cCode)
			else
		...
		for nTimes = 1 to 2 step 1 { 
			switch nStyle { 
				...
				case C_ENV_STYLE_SIMPLEBLACK
					...
					C_STEPCOLOR_STARTPOINT = "#ffffff"
					C_STEPSTREE_LIGHTTREELINES = 2
				case C_ENV_STYLE_BLUE
					StyleFusionBlue()
					StyleColorBlue()
					C_STEPCOLOR_STARTPOINT = "#ffffff"
					C_STEPSTREE_LIGHTTREELINES = 2
				case C_ENV_STYLE_BLUE2
					StyleFusionBlue()
					StyleColorBlue2()
					C_STEPCOLOR_STARTPOINT = "#ffffff"
					C_STEPSTREE_LIGHTTREELINES = 2
