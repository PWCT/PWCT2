...
class stdlib_trimComponentController from ComponentControllerParent 
	...
	func GenerateAction 
				...
				switch Variable(:Value2) {
					...
					case 1 cFunc = "trimall" 
					case 2 cFunc = "trimleft" 
					case 3 cFunc = "trimright" 
		
				}
		
				NewStep( StepData(:Value3) + " = "  +  T_CT_STDLIB_TRIM_ST_VALUE  +
					 StepData(:Value ) +  T_CT_STDLIB_TRIM_ST_VALUE2 + 
					StyleData(T_CT_STDLIB_TRIM_IP_VALUE2LIST[Variable(:Value2)])  )
...
class stdlib_trimComponentView from ComponentViewParent
		...
		ListBox( T_CT_STDLIB_TRIM_IP_VALUE2 , :value2, 
				T_CT_STDLIB_TRIM_IP_VALUE2LIST )
