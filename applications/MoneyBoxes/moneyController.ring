...
class moneyController from windowsControllerParent
	...
	aMoney = [0,5,10,15,25,50,75,100,150,175,200,250,300,400,475,500,1000,1200,2000]
	...
	nAmount
	nOpened
	aButtons = [oView.button1,oView.button2,oView.button3,oView.button4,oView.button5,oView.button6,oView.button7,oView.button8,oView.button9,oView.button10,oView.button11,oView.button12,oView.button13,oView.button14,oView.button15,oView.button16,oView.button17,oView.button18,oView.button19]
	NewGame()
	func CenterWindow  { 
	...
	func NewGame  { 
		...
		nOpened = 0
		DisplayStatus()
		for oButton in aButtons step 1 { 
			oButton {
				setStyleSheet("")
				BlockSignals(False)
			}
