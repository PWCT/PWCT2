...
### Size of Window
hSize = 8+2+2
### Size of array, Display -4 smaller
vSize = 8+2+2
### Size of array, Display -4 smaller
h = 0
...
animationDelay = 0.5
###	 Sleep 1 second between Computer Moves display
###=============================================================================
###=============================================================================
...
func DrawWidget () { 
	...
	workWidget = new qWidget()
	{
		...
		aArray = list(hSize,vSize)
		### Internal Array with Letters
		aButton = list(hSize,vSize)
		### Internal Array with Letters
