...
while !WindowShouldClose() { 
	if IsMouseButtonPressed(MOUSE_LEFT_BUTTON) { 
		if !collision { 
			...
			collision = GetRayCollisionBox(ray,BoundingBox(cubePosition.x-cubeSize.x/2,cubePosition.y-cubeSize.y/2,cubePosition.z-cubeSize.z/2,cubePosition.x+cubeSize.x/2,cubePosition.y+cubeSize.y/2,cubePosition.z+cubeSize.z/2))
