...
for item in positions step 1 { 
	item = vector3(0,0,0)
} 
colors = list(MAX_COLUMNS)
for item in colors step 1 { 
	item = BLACK
} 
for i = 1 to MAX_COLUMNS step 1 { 
...
while !WindowShouldClose() { 
	...
	#Draw ground
	DrawCube(Vector3(-16,2.5,0),1,5,32,BLUE)
	#Draw a blue wall
	DrawCube(Vector3(16,2.5,0),1,5,32,LIME)
	#Draw a green wall
	DrawCube(Vector3(0,2.5,16),32,5,1,GOLD)
	#Draw a yellow wall
	for i = 1 to MAX_COLUMNS step 1 { 
