class GameDraw
	...
	func DrawTextWithShadow cText,nY,nX,oFont,oColor { 
		al_draw_text(oFont,COLOR_GRAY,nX,nY,ALLEGRO_ALIGN_LEFT,cText)
		al_draw_text(oFont,COLOR_BLACK,nX-6,nY-6,ALLEGRO_ALIGN_LEFT,cText)
		al_draw_text(oFont,COLOR_BLACK,nX-4,nY-4,ALLEGRO_ALIGN_LEFT,cText)
		al_draw_text(oFont,oColor,nX-5,nY-5,ALLEGRO_ALIGN_LEFT,cText)
	} 
