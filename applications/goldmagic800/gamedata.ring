class GameData from GameBase
	...
	nStoryLine = 1
	nStoryCharacter = 0
	aStoryContent = [["Imagine that we have all of this Gold!","Oh My Goodness!","How many Boxes do we need?","Oh! We will need many of them!","It's our Time to be the Richest People in the world!","How?"],["I discovered this Box!","It's a Unique and Special Box","Created by the Best Wizard in World","7000 Years Ago!","It's an Infinite Source of Gold!","When We close it and move it!","We will find a New Gold under the Box!"],["The Box Exists in a Special Environment!","Full of Puzzles!","If You tried to enter this Environment","The Magic Will Destroy You","So I Created a Robot using Nanotechnology","To be able to control the Box"],["Using this Device","Once We solve all of the Puzzles","We will own the box!","Let's go!"]]
